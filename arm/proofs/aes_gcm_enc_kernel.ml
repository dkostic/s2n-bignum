...
(*   - Backedge is `cmp x0, x5; b.lt`, a flag-conditional backedge.         *)
(*   - Counter goes from 0 to N (counter = (X0 - X0_init) DIV 0x40).         *)
(*   - Use `ENSURES_WHILE_PUP_TAC` (post-form, counts up).                   *)
(*                                                                           *)
