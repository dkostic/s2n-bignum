...
(*               ; Postcondition Q11 is in the same kernel form as the      *)
(*               ; precondition: a byteswap128 (or equivalent kernel-form   *)
(*               ; permutation) of the new spec-form running tag.  The     *)
(*               ; exact byteswap orientation will be determined by the    *)
(*               ; body's ext/rev64 ops when the proof is attempted.       *)
(*               read Q11 s = byteswap128 (nist_ghash h running_tag         *)
