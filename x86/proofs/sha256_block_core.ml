...
(* ========================================================================= *)
(* GROUP6_TAC: symbolic execution of group 6 (steps 67-77) + CUT_POINT 6.    *)
(*                                                                           *)
(* Register rotation: cur=XMM5, MSG2_dst=XMM6, ext_dst=XMM3, MSG1_dst=XMM4.  *)
(*                                                                           *)
(* Instruction layout (pc+341..pc+386, steps 67-77):                         *)
(*   67: movdqa     xmm0, [rcx+96]  — K24..K27 load                          *)
(*   68: paddd      xmm0, xmm5      — K24..K27 + w24..w27                    *)
(*   69: sha256msg2 xmm6, xmm5      — completes w_{28..31} in XMM6           *)
(*   70: sha256rnds2 xmm2, xmm1                                              *)
(*   71: pshufd     xmm0, xmm0, 0x0e                                         *)
(*   72: movdqa     xmm7, xmm6                                               *)
(*   73: palignr    xmm7, xmm5, 4                                            *)
(*   74: nop                                                                  *)
(*   75: paddd      xmm3, xmm7      — schedule extension                      *)
(*   76: sha256msg1 xmm4, xmm5      — starts triple w_{32..35}               *)
(*   77: sha256rnds2 xmm1, xmm2                                              *)
(* ========================================================================= *)

let GROUP6_TAC : tactic =
  let WKDC_OUTER_6 = SPECL
   [`ABEF_PACK (EL 0 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 24 W [a;b;c;d;e;ff;g;h])) :int128`;
    `sha_ni_rnds2
       (CDGH_PACK (EL 2 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
                  (EL 3 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
                  (EL 6 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
                  (EL 7 (sha256_compress 24 W [a;b;c;d;e;ff;g;h])))
       (ABEF_PACK (EL 0 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
                  (EL 1 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
                  (EL 4 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
                  (EL 5 (sha256_compress 24 W [a;b;c;d;e;ff;g;h])))
       (word_join4 (word_add (EL 24 sha256_K) (EL 24 W))
                   (word_add (EL 25 sha256_K) (EL 25 W))
                   (word 0) (word 0)) :int128`;
    `word_add (EL 26 sha256_K) (EL 26 W) :int32`;
    `word_add (EL 27 sha256_K) (EL 27 W) :int32`;
    `word_add (EL 24 sha256_K) (EL 24 W) :int32`;
    `word_add (EL 24 sha256_K) (EL 24 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let WKDC_INNER_6 = SPECL
   [`CDGH_PACK (EL 2 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
               (EL 3 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
               (EL 6 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
               (EL 7 (sha256_compress 24 W [a;b;c;d;e;ff;g;h])) :int128`;
    `ABEF_PACK (EL 0 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 24 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 24 W [a;b;c;d;e;ff;g;h])) :int128`;
    `word_add (EL 24 sha256_K) (EL 24 W) :int32`;
    `word_add (EL 25 sha256_K) (EL 25 W) :int32`;
    `word_add (EL 26 sha256_K) (EL 26 W) :int32`;
    `word_add (EL 27 sha256_K) (EL 27 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let len_h_thm = prove
   (`LENGTH [a:int32;b;c;d;e;ff;g;h] = 8`,
    REWRITE_TAC[LENGTH] THEN ARITH_TAC) in
  let compress_el_shift_5 =
    CONV_RULE(DEPTH_CONV NUM_ADD_CONV)
     (MATCH_MP
        (SPECL [`22`; `W:int32 list`; `[a:int32;b;c;d;e;ff;g;h]`]
               COMPRESS_EL_SHIFT_2)
        len_h_thm) in
  (* Step 67: movdqa xmm0, [rcx+96] (K24..K27) *)
  X86_STEPS_TAC HW_EXEC [67] THEN
  SUBGOAL_THEN
   `read XMM0 s67 = word_join4 (EL 24 sha256_K) (EL 25 sha256_K)
                              (EL 26 sha256_K) (EL 27 sha256_K) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 68: paddd xmm0, xmm5 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s68" THEN PADDD_REFOLD_TAC THEN
  SUBGOAL_THEN
   `read XMM0 s68 =
      word_join4 (word_add (EL 24 sha256_K) (EL 24 W))
                 (word_add (EL 25 sha256_K) (EL 25 W))
                 (word_add (EL 26 sha256_K) (EL 26 W))
                 (word_add (EL 27 sha256_K) (EL 27 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s68" THEN
  (* Step 69: sha256msg2 xmm6, xmm5.  Assert the raw sha_ni_msg2 form, apply
     SHA256MSG2_BRIDGE, then two-phase lane normalization to EL 28..31 W. *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s69" THEN
  FOLD_SHA_NI_MSG2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
   ...
   `read XMM6 s69 =
      sha_ni_msg2
        (word_join4 (word_add (word_add w12 (sha256_sigma0 w13)) (EL 21 W))
                    ...
                    (word_add (word_add w14 (sha256_sigma0 w15)) (EL 23 W))
                    (word_add (word_add w15 (sha256_sigma0 (EL 16 W))) (EL 24 W)))
        (word_join4 (EL 24 W) (EL 25 W) (EL 26 W) (EL 27 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM6; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  UNDISCH_THEN
   ...
   (fun th ->
      ASSUME_TAC(CONV_RULE(RAND_CONV(REWR_CONV SHA256MSG2_BRIDGE THENC
                                     TOP_DEPTH_CONV let_CONV)) th)) THEN
  (* MSG2 output lanes: phase 1 (lanes 0,1 → EL 28/29 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add w12 (sha256_sigma0 w13)) (EL 21 W))
             (sha256_sigma1 (EL 26 W)) :int32 = EL 28 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add w13 (sha256_sigma0 w14)) (EL 22 W))
             (sha256_sigma1 (EL 27 W)) :int32 = EL 29 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add w12 (sha256_sigma0 w13)) (EL 21 W))
             (sha256_sigma1 (EL 26 W)) :int32 = EL 28 W`
   `word_add (word_add (word_add w13 (sha256_sigma0 w14)) (EL 22 W))
             (sha256_sigma1 (EL 27 W)) :int32 = EL 29 W` THEN
  (* Phase 2 (lanes 2,3 → EL 30/31 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add w14 (sha256_sigma0 w15)) (EL 23 W))
             (sha256_sigma1 (EL 28 W)) :int32 = EL 30 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add w15 (sha256_sigma0 (EL 16 W))) (EL 24 W))
             (sha256_sigma1 (EL 29 W)) :int32 = EL 31 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add w14 (sha256_sigma0 w15)) (EL 23 W))
             (sha256_sigma1 (EL 28 W)) :int32 = EL 30 W`
   `word_add (word_add (word_add w15 (sha256_sigma0 (EL 16 W))) (EL 24 W))
             (sha256_sigma1 (EL 29 W)) :int32 = EL 31 W` THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 2000))) THEN
  DISCARD_OLDSTATE_TAC "s69" THEN
  (* Shift XMM2 from ABEF_PACK (compress 22) to CDGH_PACK (compress 24). *)
  SUBGOAL_THEN
   `read XMM2 s69 = CDGH_PACK
     (EL 2 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))
     (EL 3 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))
     (EL 6 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))
     (EL 7 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[CDGH_EQ_ABEF] THEN
    REWRITE_TAC[compress_el_shift_5]; ALL_TAC] THEN
  UNDISCH_TAC `read XMM2 s69 = ABEF_PACK
     (EL 0 (sha256_compress 22 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 22 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 22 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 22 W [a; b; c; d; e; ff; g; h]))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  (* Step 70: sha256rnds2 xmm2, xmm1 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s70" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  UNDISCH_THEN
   ...
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  UNDISCH_THEN
   `read XMM1 s69 = ABEF_PACK
     (EL 0 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))`
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  ...
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s70" THEN
  (* Step 71: pshufd xmm0, xmm0, 0x0e *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s71" THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM0 s71 =
      word_join4 (word_add (EL 26 sha256_K) (EL 26 W))
                 (word_add (EL 27 sha256_K) (EL 27 W))
                 (word_add (EL 24 sha256_K) (EL 24 W))
                 (word_add (EL 24 sha256_K) (EL 24 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 72: movdqa xmm7, xmm6 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s72" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBGOAL_THEN
   `read XMM7 s72 = word_join4 (EL 28 W) (EL 29 W) (EL 30 W) (EL 31 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s72" THEN
  (* Step 73: palignr xmm7, xmm5, 0x4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s73" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[PALIGNR_4_WORD_JOIN4]) THEN
  SUBGOAL_THEN
   `read XMM7 s73 =
      word_join4 (EL 25 W) (EL 26 W) (EL 27 W) (EL 28 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s73" THEN
  (* Step 74: nop *)
  X86_STEPS_TAC HW_EXEC [74] THEN
  (* Step 75: paddd xmm3, xmm7.  Pre-expand XMM3 s74 from sha_ni_msg1 to raw
     word_join4 via SHA256MSG1_BRIDGE.  XMM3 s66 =
     sha_ni_msg1 (word_join4 EL 16..19 W) (word_join4 EL 20..23 W);
     post-bridge lane j = EL (16+j) W + σ0 (EL (17+j) W).  XMM7 s74 =
     word_join4 (EL 25..28 W).  After PADDD lane j =
     (EL (16+j) W + σ0 (EL (17+j) W)) + EL (j+25) W. *)
  SUBGOAL_THEN
   `read XMM3 s74 =
      word_join4 (word_add (EL 16 W) (sha256_sigma0 (EL 17 W)))
                 (word_add (EL 17 W) (sha256_sigma0 (EL 18 W)))
                 (word_add (EL 18 W) (sha256_sigma0 (EL 19 W)))
                 (word_add (EL 19 W) (sha256_sigma0 (EL 20 W))) :int128`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[SHA256MSG1_BRIDGE]; ALL_TAC] THEN
  UNDISCH_TAC
   `read XMM3 s74 =
      sha_ni_msg1 (word_join4 (EL 16 W) (EL 17 W) (EL 18 W) (EL 19 W))
                  (word_join4 (EL 20 W) (EL 21 W) (EL 22 W) (EL 23 W))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  X86_VERBOSE_STEP_TAC HW_EXEC "s75" THEN PADDD_REFOLD_TAC THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM3 s75 =
      word_join4 (word_add (word_add (EL 16 W) (sha256_sigma0 (EL 17 W))) (EL 25 W))
                 (word_add (word_add (EL 17 W) (sha256_sigma0 (EL 18 W))) (EL 26 W))
                 (word_add (word_add (EL 18 W) (sha256_sigma0 (EL 19 W))) (EL 27 W))
                 (word_add (word_add (EL 19 W) (sha256_sigma0 (EL 20 W))) (EL 28 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM3; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s75" THEN
  (* Step 76: sha256msg1 xmm4, xmm5 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s76" THEN
  FOLD_SHA_NI_MSG1_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM4 s76 =
      sha_ni_msg1 (word_join4 (EL 20 W) (EL 21 W) (EL 22 W) (EL 23 W))
                  (word_join4 (EL 24 W) (EL 25 W) (EL 26 W) (EL 27 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM4; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s76" THEN
  (* Step 77: sha256rnds2 xmm1, xmm2 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s77" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  FIRST_ASSUM(fun th ->
    let s = string_of_term (concl th) in
    if has_sub_string "XMM2 s76 =" s && has_sub_string "sha_ni_rnds2" s
    then RULE_ASSUM_TAC(REWRITE_RULE[th]) else FAIL_TAC "not found") THEN
  UNDISCH_THEN
   `read XMM1 s76 = ABEF_PACK
     (EL 0 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 24 W [a; b; c; d; e; ff; g; h]))`
   ...
   `read XMM1 s77 =
      sha_ni_rnds2
        ...
        (word_join4 (word_add (EL 26 sha256_K) (EL 26 W))
                    (word_add (EL 27 sha256_K) (EL 27 W))
                    (word_add (EL 24 sha256_K) (EL 24 W))
                    (word_add (EL 24 sha256_K) (EL 24 W))) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM1; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s77" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WKDC_INNER_6; WKDC_OUTER_6]) THEN
  CUT_POINT_TAC_HW 6 `s77:x86state`;;

(* ========================================================================= *)
(* GROUP7_TAC: symbolic execution of group 7 (steps 78-88) + CUT_POINT 7.    *)
(*                                                                           *)
(* Register rotation: cur=XMM6, MSG2_dst=XMM3, ext_dst=XMM4, MSG1_dst=XMM5.  *)
(*                                                                           *)
(* Instruction layout (pc+386..pc+431, steps 78-88):                         *)
(*   78: movdqa     xmm0, [rcx+112] — K28..K31 load                          *)
(*   79: paddd      xmm0, xmm6      — K28..K31 + w28..w31                    *)
(*   80: sha256msg2 xmm3, xmm6      — completes w_{32..35} in XMM3           *)
(*   81: sha256rnds2 xmm2, xmm1                                              *)
(*   82: pshufd     xmm0, xmm0, 0x0e                                         *)
(*   83: movdqa     xmm7, xmm3                                               *)
(*   84: palignr    xmm7, xmm6, 4                                            *)
(*   85: nop                                                                  *)
(*   86: paddd      xmm4, xmm7      — schedule extension                      *)
(*   87: sha256msg1 xmm5, xmm6      — starts triple w_{36..39}               *)
(*   88: sha256rnds2 xmm1, xmm2                                              *)
(* ========================================================================= *)

let GROUP7_TAC : tactic =
  let WKDC_OUTER_7 = SPECL
   [`ABEF_PACK (EL 0 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 28 W [a;b;c;d;e;ff;g;h])) :int128`;
    `sha_ni_rnds2
       (CDGH_PACK (EL 2 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
                  (EL 3 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
                  (EL 6 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
                  (EL 7 (sha256_compress 28 W [a;b;c;d;e;ff;g;h])))
       (ABEF_PACK (EL 0 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
                  (EL 1 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
                  (EL 4 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
                  (EL 5 (sha256_compress 28 W [a;b;c;d;e;ff;g;h])))
       (word_join4 (word_add (EL 28 sha256_K) (EL 28 W))
                   (word_add (EL 29 sha256_K) (EL 29 W))
                   (word 0) (word 0)) :int128`;
    `word_add (EL 30 sha256_K) (EL 30 W) :int32`;
    `word_add (EL 31 sha256_K) (EL 31 W) :int32`;
    `word_add (EL 28 sha256_K) (EL 28 W) :int32`;
    `word_add (EL 28 sha256_K) (EL 28 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let WKDC_INNER_7 = SPECL
   [`CDGH_PACK (EL 2 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
               (EL 3 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
               (EL 6 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
               (EL 7 (sha256_compress 28 W [a;b;c;d;e;ff;g;h])) :int128`;
    `ABEF_PACK (EL 0 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 28 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 28 W [a;b;c;d;e;ff;g;h])) :int128`;
    `word_add (EL 28 sha256_K) (EL 28 W) :int32`;
    `word_add (EL 29 sha256_K) (EL 29 W) :int32`;
    `word_add (EL 30 sha256_K) (EL 30 W) :int32`;
    `word_add (EL 31 sha256_K) (EL 31 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let len_h_thm = prove
   (`LENGTH [a:int32;b;c;d;e;ff;g;h] = 8`,
    REWRITE_TAC[LENGTH] THEN ARITH_TAC) in
  let compress_el_shift_6 =
    CONV_RULE(DEPTH_CONV NUM_ADD_CONV)
     (MATCH_MP
        (SPECL [`26`; `W:int32 list`; `[a:int32;b;c;d;e;ff;g;h]`]
               COMPRESS_EL_SHIFT_2)
        len_h_thm) in
  (* Step 78: movdqa xmm0, [rcx+112] (K28..K31) *)
  X86_STEPS_TAC HW_EXEC [78] THEN
  SUBGOAL_THEN
   `read XMM0 s78 = word_join4 (EL 28 sha256_K) (EL 29 sha256_K)
                              (EL 30 sha256_K) (EL 31 sha256_K) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 79: paddd xmm0, xmm6 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s79" THEN PADDD_REFOLD_TAC THEN
  SUBGOAL_THEN
   `read XMM0 s79 =
      word_join4 (word_add (EL 28 sha256_K) (EL 28 W))
                 (word_add (EL 29 sha256_K) (EL 29 W))
                 (word_add (EL 30 sha256_K) (EL 30 W))
                 (word_add (EL 31 sha256_K) (EL 31 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s79" THEN
  (* Step 80: sha256msg2 xmm3, xmm6.  Assert the raw sha_ni_msg2 form, apply
     SHA256MSG2_BRIDGE, then two-phase lane normalization to EL 32..35 W. *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s80" THEN
  FOLD_SHA_NI_MSG2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM3 s80 =
      sha_ni_msg2
        (word_join4
           (word_add (word_add (EL 16 W) (sha256_sigma0 (EL 17 W))) (EL 25 W))
           (word_add (word_add (EL 17 W) (sha256_sigma0 (EL 18 W))) (EL 26 W))
           (word_add (word_add (EL 18 W) (sha256_sigma0 (EL 19 W))) (EL 27 W))
           (word_add (word_add (EL 19 W) (sha256_sigma0 (EL 20 W))) (EL 28 W)))
        (word_join4 (EL 28 W) (EL 29 W) (EL 30 W) (EL 31 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM3; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  UNDISCH_THEN
   ...
   (fun th ->
      ASSUME_TAC(CONV_RULE(RAND_CONV(REWR_CONV SHA256MSG2_BRIDGE THENC
                                     TOP_DEPTH_CONV let_CONV)) th)) THEN
  (* MSG2 output lanes: phase 1 (lanes 0,1 → EL 32/33 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 16 W) (sha256_sigma0 (EL 17 W))) (EL 25 W))
             (sha256_sigma1 (EL 30 W)) :int32 = EL 32 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 17 W) (sha256_sigma0 (EL 18 W))) (EL 26 W))
             (sha256_sigma1 (EL 31 W)) :int32 = EL 33 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 16 W) (sha256_sigma0 (EL 17 W))) (EL 25 W))
             (sha256_sigma1 (EL 30 W)) :int32 = EL 32 W`
   `word_add (word_add (word_add (EL 17 W) (sha256_sigma0 (EL 18 W))) (EL 26 W))
             (sha256_sigma1 (EL 31 W)) :int32 = EL 33 W` THEN
  (* Phase 2 (lanes 2,3 → EL 34/35 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 18 W) (sha256_sigma0 (EL 19 W))) (EL 27 W))
             (sha256_sigma1 (EL 32 W)) :int32 = EL 34 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 19 W) (sha256_sigma0 (EL 20 W))) (EL 28 W))
             (sha256_sigma1 (EL 33 W)) :int32 = EL 35 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 18 W) (sha256_sigma0 (EL 19 W))) (EL 27 W))
             (sha256_sigma1 (EL 32 W)) :int32 = EL 34 W`
   `word_add (word_add (word_add (EL 19 W) (sha256_sigma0 (EL 20 W))) (EL 28 W))
             (sha256_sigma1 (EL 33 W)) :int32 = EL 35 W` THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 2000))) THEN
  DISCARD_OLDSTATE_TAC "s80" THEN
  (* Shift XMM2 from ABEF_PACK (compress 26) to CDGH_PACK (compress 28). *)
  SUBGOAL_THEN
   `read XMM2 s80 = CDGH_PACK
     (EL 2 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))
     (EL 3 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))
     (EL 6 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))
     (EL 7 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[CDGH_EQ_ABEF] THEN
    REWRITE_TAC[compress_el_shift_6]; ALL_TAC] THEN
  UNDISCH_TAC `read XMM2 s80 = ABEF_PACK
     (EL 0 (sha256_compress 26 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 26 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 26 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 26 W [a; b; c; d; e; ff; g; h]))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  (* Step 81: sha256rnds2 xmm2, xmm1 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s81" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  UNDISCH_THEN
   ...
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  UNDISCH_THEN
   `read XMM1 s80 = ABEF_PACK
     (EL 0 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))`
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  ...
  (* Step 82: pshufd xmm0, xmm0, 0x0e *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s82" THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM0 s82 =
      word_join4 (word_add (EL 30 sha256_K) (EL 30 W))
                 (word_add (EL 31 sha256_K) (EL 31 W))
                 (word_add (EL 28 sha256_K) (EL 28 W))
                 (word_add (EL 28 sha256_K) (EL 28 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 83: movdqa xmm7, xmm3 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s83" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBGOAL_THEN
   `read XMM7 s83 = word_join4 (EL 32 W) (EL 33 W) (EL 34 W) (EL 35 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s83" THEN
  (* Step 84: palignr xmm7, xmm6, 0x4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s84" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[PALIGNR_4_WORD_JOIN4]) THEN
  SUBGOAL_THEN
   `read XMM7 s84 =
      word_join4 (EL 29 W) (EL 30 W) (EL 31 W) (EL 32 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s84" THEN
  (* Step 85: nop *)
  X86_STEPS_TAC HW_EXEC [85] THEN
  (* Step 86: paddd xmm4, xmm7.  Pre-expand XMM4 s85 from sha_ni_msg1 to raw
     word_join4 via SHA256MSG1_BRIDGE.  XMM4 s77 =
     sha_ni_msg1 (word_join4 EL 20..23 W) (word_join4 EL 24..27 W);
     post-bridge lane j = EL (20+j) W + σ0 (EL (21+j) W).  XMM7 s85 =
     word_join4 (EL 29..32 W).  After PADDD lane j =
     (EL (20+j) W + σ0 (EL (21+j) W)) + EL (j+29) W. *)
  SUBGOAL_THEN
   `read XMM4 s85 =
      word_join4 (word_add (EL 20 W) (sha256_sigma0 (EL 21 W)))
                 (word_add (EL 21 W) (sha256_sigma0 (EL 22 W)))
                 (word_add (EL 22 W) (sha256_sigma0 (EL 23 W)))
                 (word_add (EL 23 W) (sha256_sigma0 (EL 24 W))) :int128`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[SHA256MSG1_BRIDGE]; ALL_TAC] THEN
  UNDISCH_TAC
   `read XMM4 s85 =
      sha_ni_msg1 (word_join4 (EL 20 W) (EL 21 W) (EL 22 W) (EL 23 W))
                  (word_join4 (EL 24 W) (EL 25 W) (EL 26 W) (EL 27 W))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  X86_VERBOSE_STEP_TAC HW_EXEC "s86" THEN PADDD_REFOLD_TAC THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM4 s86 =
      word_join4 (word_add (word_add (EL 20 W) (sha256_sigma0 (EL 21 W))) (EL 29 W))
                 (word_add (word_add (EL 21 W) (sha256_sigma0 (EL 22 W))) (EL 30 W))
                 (word_add (word_add (EL 22 W) (sha256_sigma0 (EL 23 W))) (EL 31 W))
                 (word_add (word_add (EL 23 W) (sha256_sigma0 (EL 24 W))) (EL 32 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM4; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s86" THEN
  (* Step 87: sha256msg1 xmm5, xmm6 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s87" THEN
  FOLD_SHA_NI_MSG1_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM5 s87 =
      sha_ni_msg1 (word_join4 (EL 24 W) (EL 25 W) (EL 26 W) (EL 27 W))
                  (word_join4 (EL 28 W) (EL 29 W) (EL 30 W) (EL 31 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM5; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s87" THEN
  (* Step 88: sha256rnds2 xmm1, xmm2 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s88" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  FIRST_ASSUM(fun th ->
    let s = string_of_term (concl th) in
    if has_sub_string "XMM2 s87 =" s && has_sub_string "sha_ni_rnds2" s
    then RULE_ASSUM_TAC(REWRITE_RULE[th]) else FAIL_TAC "not found") THEN
  UNDISCH_THEN
   `read XMM1 s87 = ABEF_PACK
     (EL 0 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 28 W [a; b; c; d; e; ff; g; h]))`
   ...
   `read XMM1 s88 =
      sha_ni_rnds2
        ...
        (word_join4 (word_add (EL 30 sha256_K) (EL 30 W))
                    (word_add (EL 31 sha256_K) (EL 31 W))
                    (word_add (EL 28 sha256_K) (EL 28 W))
                    (word_add (EL 28 sha256_K) (EL 28 W))) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM1; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s88" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WKDC_INNER_7; WKDC_OUTER_7]) THEN
  CUT_POINT_TAC_HW 7 `s88:x86state`;;

(* ========================================================================= *)
(* GROUP8_TAC: symbolic execution of group 8 (steps 89-99) + CUT_POINT 8.    *)
(*                                                                           *)
(* Register rotation: cur=XMM3, MSG2_dst=XMM4, ext_dst=XMM5, MSG1_dst=XMM6.  *)
(* (Wraps back to the G4 rotation pattern.)                                  *)
(*                                                                           *)
(* Instruction layout (pc+431..pc+479, steps 89-99):                         *)
(*   89: movdqa     xmm0, [rcx+128] — K32..K35 load                          *)
(*   90: paddd      xmm0, xmm3      — K32..K35 + w32..w35                    *)
(*   91: sha256msg2 xmm4, xmm3      — completes w_{36..39} in XMM4           *)
(*   92: sha256rnds2 xmm2, xmm1                                              *)
(*   93: pshufd     xmm0, xmm0, 0x0e                                         *)
(*   94: movdqa     xmm7, xmm4                                               *)
(*   95: palignr    xmm7, xmm3, 4                                            *)
(*   96: nop                                                                  *)
(*   97: paddd      xmm5, xmm7      — schedule extension                      *)
(*   98: sha256msg1 xmm6, xmm3      — starts triple w_{40..43}               *)
(*   99: sha256rnds2 xmm1, xmm2                                              *)
(* ========================================================================= *)

let GROUP8_TAC : tactic =
  let WKDC_OUTER_8 = SPECL
   [`ABEF_PACK (EL 0 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 32 W [a;b;c;d;e;ff;g;h])) :int128`;
    `sha_ni_rnds2
       (CDGH_PACK (EL 2 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
                  (EL 3 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
                  (EL 6 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
                  (EL 7 (sha256_compress 32 W [a;b;c;d;e;ff;g;h])))
       (ABEF_PACK (EL 0 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
                  (EL 1 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
                  (EL 4 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
                  (EL 5 (sha256_compress 32 W [a;b;c;d;e;ff;g;h])))
       (word_join4 (word_add (EL 32 sha256_K) (EL 32 W))
                   (word_add (EL 33 sha256_K) (EL 33 W))
                   (word 0) (word 0)) :int128`;
    `word_add (EL 34 sha256_K) (EL 34 W) :int32`;
    `word_add (EL 35 sha256_K) (EL 35 W) :int32`;
    `word_add (EL 32 sha256_K) (EL 32 W) :int32`;
    `word_add (EL 32 sha256_K) (EL 32 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let WKDC_INNER_8 = SPECL
   [`CDGH_PACK (EL 2 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
               (EL 3 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
               (EL 6 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
               (EL 7 (sha256_compress 32 W [a;b;c;d;e;ff;g;h])) :int128`;
    `ABEF_PACK (EL 0 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 32 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 32 W [a;b;c;d;e;ff;g;h])) :int128`;
    `word_add (EL 32 sha256_K) (EL 32 W) :int32`;
    `word_add (EL 33 sha256_K) (EL 33 W) :int32`;
    `word_add (EL 34 sha256_K) (EL 34 W) :int32`;
    `word_add (EL 35 sha256_K) (EL 35 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let len_h_thm = prove
   (`LENGTH [a:int32;b;c;d;e;ff;g;h] = 8`,
    REWRITE_TAC[LENGTH] THEN ARITH_TAC) in
  let compress_el_shift_7 =
    CONV_RULE(DEPTH_CONV NUM_ADD_CONV)
     (MATCH_MP
        (SPECL [`30`; `W:int32 list`; `[a:int32;b;c;d;e;ff;g;h]`]
               COMPRESS_EL_SHIFT_2)
        len_h_thm) in
  (* Step 89: movdqa xmm0, [rcx+128] (K32..K35) *)
  X86_STEPS_TAC HW_EXEC [89] THEN
  SUBGOAL_THEN
   `read XMM0 s89 = word_join4 (EL 32 sha256_K) (EL 33 sha256_K)
                              (EL 34 sha256_K) (EL 35 sha256_K) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 90: paddd xmm0, xmm3 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s90" THEN PADDD_REFOLD_TAC THEN
  SUBGOAL_THEN
   `read XMM0 s90 =
      word_join4 (word_add (EL 32 sha256_K) (EL 32 W))
                 (word_add (EL 33 sha256_K) (EL 33 W))
                 (word_add (EL 34 sha256_K) (EL 34 W))
                 (word_add (EL 35 sha256_K) (EL 35 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s90" THEN
  (* Step 91: sha256msg2 xmm4, xmm3.  Assert the raw sha_ni_msg2 form, apply
     SHA256MSG2_BRIDGE, then two-phase lane normalization to EL 36..39 W. *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s91" THEN
  FOLD_SHA_NI_MSG2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM4 s91 =
      sha_ni_msg2
        (word_join4
           (word_add (word_add (EL 20 W) (sha256_sigma0 (EL 21 W))) (EL 29 W))
           (word_add (word_add (EL 21 W) (sha256_sigma0 (EL 22 W))) (EL 30 W))
           (word_add (word_add (EL 22 W) (sha256_sigma0 (EL 23 W))) (EL 31 W))
           (word_add (word_add (EL 23 W) (sha256_sigma0 (EL 24 W))) (EL 32 W)))
        (word_join4 (EL 32 W) (EL 33 W) (EL 34 W) (EL 35 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM4; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  UNDISCH_THEN
   ...
   (fun th ->
      ASSUME_TAC(CONV_RULE(RAND_CONV(REWR_CONV SHA256MSG2_BRIDGE THENC
                                     TOP_DEPTH_CONV let_CONV)) th)) THEN
  (* MSG2 output lanes: phase 1 (lanes 0,1 → EL 36/37 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 20 W) (sha256_sigma0 (EL 21 W))) (EL 29 W))
             (sha256_sigma1 (EL 34 W)) :int32 = EL 36 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 21 W) (sha256_sigma0 (EL 22 W))) (EL 30 W))
             (sha256_sigma1 (EL 35 W)) :int32 = EL 37 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 20 W) (sha256_sigma0 (EL 21 W))) (EL 29 W))
             (sha256_sigma1 (EL 34 W)) :int32 = EL 36 W`
   `word_add (word_add (word_add (EL 21 W) (sha256_sigma0 (EL 22 W))) (EL 30 W))
             (sha256_sigma1 (EL 35 W)) :int32 = EL 37 W` THEN
  (* Phase 2 (lanes 2,3 → EL 38/39 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 22 W) (sha256_sigma0 (EL 23 W))) (EL 31 W))
             (sha256_sigma1 (EL 36 W)) :int32 = EL 38 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 23 W) (sha256_sigma0 (EL 24 W))) (EL 32 W))
             (sha256_sigma1 (EL 37 W)) :int32 = EL 39 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 22 W) (sha256_sigma0 (EL 23 W))) (EL 31 W))
             (sha256_sigma1 (EL 36 W)) :int32 = EL 38 W`
   `word_add (word_add (word_add (EL 23 W) (sha256_sigma0 (EL 24 W))) (EL 32 W))
             (sha256_sigma1 (EL 37 W)) :int32 = EL 39 W` THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 2000))) THEN
  DISCARD_OLDSTATE_TAC "s91" THEN
  (* Shift XMM2 from ABEF_PACK (compress 30) to CDGH_PACK (compress 32). *)
  SUBGOAL_THEN
   `read XMM2 s91 = CDGH_PACK
     (EL 2 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))
     (EL 3 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))
     (EL 6 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))
     (EL 7 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[CDGH_EQ_ABEF] THEN
    REWRITE_TAC[compress_el_shift_7]; ALL_TAC] THEN
  UNDISCH_TAC `read XMM2 s91 = ABEF_PACK
     (EL 0 (sha256_compress 30 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 30 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 30 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 30 W [a; b; c; d; e; ff; g; h]))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  (* Step 92: sha256rnds2 xmm2, xmm1 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s92" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  UNDISCH_THEN
   ...
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  UNDISCH_THEN
   `read XMM1 s91 = ABEF_PACK
     (EL 0 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))`
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  ...
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s92" THEN
  (* Step 93: pshufd xmm0, xmm0, 0x0e *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s93" THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM0 s93 =
      word_join4 (word_add (EL 34 sha256_K) (EL 34 W))
                 (word_add (EL 35 sha256_K) (EL 35 W))
                 (word_add (EL 32 sha256_K) (EL 32 W))
                 (word_add (EL 32 sha256_K) (EL 32 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 94: movdqa xmm7, xmm4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s94" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBGOAL_THEN
   `read XMM7 s94 = word_join4 (EL 36 W) (EL 37 W) (EL 38 W) (EL 39 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s94" THEN
  (* Step 95: palignr xmm7, xmm3, 0x4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s95" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[PALIGNR_4_WORD_JOIN4]) THEN
  SUBGOAL_THEN
   `read XMM7 s95 =
      word_join4 (EL 33 W) (EL 34 W) (EL 35 W) (EL 36 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s95" THEN
  (* Step 96: nop *)
  X86_STEPS_TAC HW_EXEC [96] THEN
  (* Step 97: paddd xmm5, xmm7.  Pre-expand XMM5 s96 from sha_ni_msg1 to raw
     word_join4 via SHA256MSG1_BRIDGE.  XMM5 s88 =
     sha_ni_msg1 (word_join4 EL 24..27 W) (word_join4 EL 28..31 W);
     post-bridge lane j = EL (24+j) W + σ0 (EL (25+j) W).  XMM7 s96 =
     word_join4 (EL 33..36 W).  After PADDD lane j =
     (EL (24+j) W + σ0 (EL (25+j) W)) + EL (j+33) W. *)
  SUBGOAL_THEN
   `read XMM5 s96 =
      word_join4 (word_add (EL 24 W) (sha256_sigma0 (EL 25 W)))
                 (word_add (EL 25 W) (sha256_sigma0 (EL 26 W)))
                 (word_add (EL 26 W) (sha256_sigma0 (EL 27 W)))
                 (word_add (EL 27 W) (sha256_sigma0 (EL 28 W))) :int128`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[SHA256MSG1_BRIDGE]; ALL_TAC] THEN
  UNDISCH_TAC
   `read XMM5 s96 =
      sha_ni_msg1 (word_join4 (EL 24 W) (EL 25 W) (EL 26 W) (EL 27 W))
                  (word_join4 (EL 28 W) (EL 29 W) (EL 30 W) (EL 31 W))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  X86_VERBOSE_STEP_TAC HW_EXEC "s97" THEN PADDD_REFOLD_TAC THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM5 s97 =
      word_join4 (word_add (word_add (EL 24 W) (sha256_sigma0 (EL 25 W))) (EL 33 W))
                 (word_add (word_add (EL 25 W) (sha256_sigma0 (EL 26 W))) (EL 34 W))
                 (word_add (word_add (EL 26 W) (sha256_sigma0 (EL 27 W))) (EL 35 W))
                 (word_add (word_add (EL 27 W) (sha256_sigma0 (EL 28 W))) (EL 36 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM5; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s97" THEN
  (* Step 98: sha256msg1 xmm6, xmm3 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s98" THEN
  FOLD_SHA_NI_MSG1_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM6 s98 =
      sha_ni_msg1 (word_join4 (EL 28 W) (EL 29 W) (EL 30 W) (EL 31 W))
                  (word_join4 (EL 32 W) (EL 33 W) (EL 34 W) (EL 35 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM6; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s98" THEN
  (* Step 99: sha256rnds2 xmm1, xmm2 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s99" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  FIRST_ASSUM(fun th ->
    let s = string_of_term (concl th) in
    if has_sub_string "XMM2 s98 =" s && has_sub_string "sha_ni_rnds2" s
    then RULE_ASSUM_TAC(REWRITE_RULE[th]) else FAIL_TAC "not found") THEN
  UNDISCH_THEN
   `read XMM1 s98 = ABEF_PACK
     (EL 0 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 32 W [a; b; c; d; e; ff; g; h]))`
   ...
   `read XMM1 s99 =
      sha_ni_rnds2
        ...
        (word_join4 (word_add (EL 34 sha256_K) (EL 34 W))
                    (word_add (EL 35 sha256_K) (EL 35 W))
                    (word_add (EL 32 sha256_K) (EL 32 W))
                    (word_add (EL 32 sha256_K) (EL 32 W))) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM1; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s99" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WKDC_INNER_8; WKDC_OUTER_8]) THEN
  CUT_POINT_TAC_HW 8 `s99:x86state`;;

(* ========================================================================= *)
(* GROUP9_TAC: symbolic execution of group 9 (steps 100-110) + CUT_POINT 9.  *)
(*                                                                           *)
(* Register rotation: cur=XMM4, MSG2_dst=XMM5, ext_dst=XMM6, MSG1_dst=XMM3.  *)
(* (Same rotation as G5.)                                                    *)
(*                                                                           *)
(* Instruction layout (pc+479..pc+527, steps 100-110):                       *)
(*  100: movdqa     xmm0, [rcx+144] — K36..K39 load                          *)
(*  101: paddd      xmm0, xmm4      — K36..K39 + w36..w39                    *)
(*  102: sha256msg2 xmm5, xmm4      — completes w_{40..43} in XMM5           *)
(*  103: sha256rnds2 xmm2, xmm1                                              *)
(*  104: pshufd     xmm0, xmm0, 0x0e                                         *)
(*  105: movdqa     xmm7, xmm5                                               *)
(*  106: palignr    xmm7, xmm4, 4                                            *)
(*  107: nop                                                                  *)
(*  108: paddd      xmm6, xmm7      — schedule extension                      *)
(*  109: sha256msg1 xmm3, xmm4      — starts triple w_{44..47}               *)
(*  110: sha256rnds2 xmm1, xmm2                                              *)
(* ========================================================================= *)

let GROUP9_TAC : tactic =
  let WKDC_OUTER_9 = SPECL
   [`ABEF_PACK (EL 0 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 36 W [a;b;c;d;e;ff;g;h])) :int128`;
    `sha_ni_rnds2
       (CDGH_PACK (EL 2 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
                  (EL 3 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
                  (EL 6 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
                  (EL 7 (sha256_compress 36 W [a;b;c;d;e;ff;g;h])))
       (ABEF_PACK (EL 0 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
                  (EL 1 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
                  (EL 4 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
                  (EL 5 (sha256_compress 36 W [a;b;c;d;e;ff;g;h])))
       (word_join4 (word_add (EL 36 sha256_K) (EL 36 W))
                   (word_add (EL 37 sha256_K) (EL 37 W))
                   (word 0) (word 0)) :int128`;
    `word_add (EL 38 sha256_K) (EL 38 W) :int32`;
    `word_add (EL 39 sha256_K) (EL 39 W) :int32`;
    `word_add (EL 36 sha256_K) (EL 36 W) :int32`;
    `word_add (EL 36 sha256_K) (EL 36 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let WKDC_INNER_9 = SPECL
   [`CDGH_PACK (EL 2 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
               (EL 3 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
               (EL 6 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
               (EL 7 (sha256_compress 36 W [a;b;c;d;e;ff;g;h])) :int128`;
    `ABEF_PACK (EL 0 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 36 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 36 W [a;b;c;d;e;ff;g;h])) :int128`;
    `word_add (EL 36 sha256_K) (EL 36 W) :int32`;
    `word_add (EL 37 sha256_K) (EL 37 W) :int32`;
    `word_add (EL 38 sha256_K) (EL 38 W) :int32`;
    `word_add (EL 39 sha256_K) (EL 39 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let len_h_thm = prove
   (`LENGTH [a:int32;b;c;d;e;ff;g;h] = 8`,
    REWRITE_TAC[LENGTH] THEN ARITH_TAC) in
  let compress_el_shift_8 =
    CONV_RULE(DEPTH_CONV NUM_ADD_CONV)
     (MATCH_MP
        (SPECL [`34`; `W:int32 list`; `[a:int32;b;c;d;e;ff;g;h]`]
               COMPRESS_EL_SHIFT_2)
        len_h_thm) in
  (* Step 100: movdqa xmm0, [rcx+144] (K36..K39) *)
  X86_STEPS_TAC HW_EXEC [100] THEN
  SUBGOAL_THEN
   `read XMM0 s100 = word_join4 (EL 36 sha256_K) (EL 37 sha256_K)
                              (EL 38 sha256_K) (EL 39 sha256_K) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 101: paddd xmm0, xmm4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s101" THEN PADDD_REFOLD_TAC THEN
  SUBGOAL_THEN
   `read XMM0 s101 =
      word_join4 (word_add (EL 36 sha256_K) (EL 36 W))
                 (word_add (EL 37 sha256_K) (EL 37 W))
                 (word_add (EL 38 sha256_K) (EL 38 W))
                 (word_add (EL 39 sha256_K) (EL 39 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s101" THEN
  (* Step 102: sha256msg2 xmm5, xmm4.  Assert the raw sha_ni_msg2 form, apply
     SHA256MSG2_BRIDGE, then two-phase lane normalization to EL 40..43 W. *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s102" THEN
  FOLD_SHA_NI_MSG2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM5 s102 =
      sha_ni_msg2
        (word_join4
           (word_add (word_add (EL 24 W) (sha256_sigma0 (EL 25 W))) (EL 33 W))
           (word_add (word_add (EL 25 W) (sha256_sigma0 (EL 26 W))) (EL 34 W))
           (word_add (word_add (EL 26 W) (sha256_sigma0 (EL 27 W))) (EL 35 W))
           (word_add (word_add (EL 27 W) (sha256_sigma0 (EL 28 W))) (EL 36 W)))
        (word_join4 (EL 36 W) (EL 37 W) (EL 38 W) (EL 39 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM5; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  UNDISCH_THEN
   ...
   (fun th ->
      ASSUME_TAC(CONV_RULE(RAND_CONV(REWR_CONV SHA256MSG2_BRIDGE THENC
                                     TOP_DEPTH_CONV let_CONV)) th)) THEN
  (* MSG2 output lanes: phase 1 (lanes 0,1 → EL 40/41 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 24 W) (sha256_sigma0 (EL 25 W))) (EL 33 W))
             (sha256_sigma1 (EL 38 W)) :int32 = EL 40 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 25 W) (sha256_sigma0 (EL 26 W))) (EL 34 W))
             (sha256_sigma1 (EL 39 W)) :int32 = EL 41 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 24 W) (sha256_sigma0 (EL 25 W))) (EL 33 W))
             (sha256_sigma1 (EL 38 W)) :int32 = EL 40 W`
   `word_add (word_add (word_add (EL 25 W) (sha256_sigma0 (EL 26 W))) (EL 34 W))
             (sha256_sigma1 (EL 39 W)) :int32 = EL 41 W` THEN
  (* Phase 2 (lanes 2,3 → EL 42/43 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 26 W) (sha256_sigma0 (EL 27 W))) (EL 35 W))
             (sha256_sigma1 (EL 40 W)) :int32 = EL 42 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 27 W) (sha256_sigma0 (EL 28 W))) (EL 36 W))
             (sha256_sigma1 (EL 41 W)) :int32 = EL 43 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 26 W) (sha256_sigma0 (EL 27 W))) (EL 35 W))
             (sha256_sigma1 (EL 40 W)) :int32 = EL 42 W`
   `word_add (word_add (word_add (EL 27 W) (sha256_sigma0 (EL 28 W))) (EL 36 W))
             (sha256_sigma1 (EL 41 W)) :int32 = EL 43 W` THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 2000))) THEN
  DISCARD_OLDSTATE_TAC "s102" THEN
  (* Shift XMM2 from ABEF_PACK (compress 34) to CDGH_PACK (compress 36). *)
  SUBGOAL_THEN
   `read XMM2 s102 = CDGH_PACK
     (EL 2 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))
     (EL 3 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))
     (EL 6 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))
     (EL 7 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[CDGH_EQ_ABEF] THEN
    REWRITE_TAC[compress_el_shift_8]; ALL_TAC] THEN
  UNDISCH_TAC `read XMM2 s102 = ABEF_PACK
     (EL 0 (sha256_compress 34 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 34 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 34 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 34 W [a; b; c; d; e; ff; g; h]))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  (* Step 103: sha256rnds2 xmm2, xmm1 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s103" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  UNDISCH_THEN
   ...
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  UNDISCH_THEN
   `read XMM1 s102 = ABEF_PACK
     (EL 0 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))`
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  ...
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s103" THEN
  (* Step 104: pshufd xmm0, xmm0, 0x0e *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s104" THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM0 s104 =
      word_join4 (word_add (EL 38 sha256_K) (EL 38 W))
                 (word_add (EL 39 sha256_K) (EL 39 W))
                 (word_add (EL 36 sha256_K) (EL 36 W))
                 (word_add (EL 36 sha256_K) (EL 36 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 105: movdqa xmm7, xmm5 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s105" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBGOAL_THEN
   `read XMM7 s105 = word_join4 (EL 40 W) (EL 41 W) (EL 42 W) (EL 43 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s105" THEN
  (* Step 106: palignr xmm7, xmm4, 0x4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s106" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[PALIGNR_4_WORD_JOIN4]) THEN
  SUBGOAL_THEN
   `read XMM7 s106 =
      word_join4 (EL 37 W) (EL 38 W) (EL 39 W) (EL 40 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s106" THEN
  (* Step 107: nop *)
  X86_STEPS_TAC HW_EXEC [107] THEN
  (* Step 108: paddd xmm6, xmm7.  Pre-expand XMM6 s107 from sha_ni_msg1 to raw
     word_join4 via SHA256MSG1_BRIDGE.  XMM6 s99 =
     sha_ni_msg1 (word_join4 EL 28..31 W) (word_join4 EL 32..35 W);
     post-bridge lane j = EL (28+j) W + σ0 (EL (29+j) W).  XMM7 s107 =
     word_join4 (EL 37..40 W).  After PADDD lane j =
     (EL (28+j) W + σ0 (EL (29+j) W)) + EL (j+37) W. *)
  SUBGOAL_THEN
   `read XMM6 s107 =
      word_join4 (word_add (EL 28 W) (sha256_sigma0 (EL 29 W)))
                 (word_add (EL 29 W) (sha256_sigma0 (EL 30 W)))
                 (word_add (EL 30 W) (sha256_sigma0 (EL 31 W)))
                 (word_add (EL 31 W) (sha256_sigma0 (EL 32 W))) :int128`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[SHA256MSG1_BRIDGE]; ALL_TAC] THEN
  UNDISCH_TAC
   `read XMM6 s107 =
      sha_ni_msg1 (word_join4 (EL 28 W) (EL 29 W) (EL 30 W) (EL 31 W))
                  (word_join4 (EL 32 W) (EL 33 W) (EL 34 W) (EL 35 W))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  X86_VERBOSE_STEP_TAC HW_EXEC "s108" THEN PADDD_REFOLD_TAC THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM6 s108 =
      word_join4 (word_add (word_add (EL 28 W) (sha256_sigma0 (EL 29 W))) (EL 37 W))
                 (word_add (word_add (EL 29 W) (sha256_sigma0 (EL 30 W))) (EL 38 W))
                 (word_add (word_add (EL 30 W) (sha256_sigma0 (EL 31 W))) (EL 39 W))
                 (word_add (word_add (EL 31 W) (sha256_sigma0 (EL 32 W))) (EL 40 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM6; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s108" THEN
  (* Step 109: sha256msg1 xmm3, xmm4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s109" THEN
  FOLD_SHA_NI_MSG1_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM3 s109 =
      sha_ni_msg1 (word_join4 (EL 32 W) (EL 33 W) (EL 34 W) (EL 35 W))
                  (word_join4 (EL 36 W) (EL 37 W) (EL 38 W) (EL 39 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM3; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s109" THEN
  (* Step 110: sha256rnds2 xmm1, xmm2 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s110" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  FIRST_ASSUM(fun th ->
    let s = string_of_term (concl th) in
    if has_sub_string "XMM2 s109 =" s && has_sub_string "sha_ni_rnds2" s
    then RULE_ASSUM_TAC(REWRITE_RULE[th]) else FAIL_TAC "not found") THEN
  UNDISCH_THEN
   `read XMM1 s109 = ABEF_PACK
     (EL 0 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 36 W [a; b; c; d; e; ff; g; h]))`
   ...
   `read XMM1 s110 =
      sha_ni_rnds2
        ...
        (word_join4 (word_add (EL 38 sha256_K) (EL 38 W))
                    (word_add (EL 39 sha256_K) (EL 39 W))
                    (word_add (EL 36 sha256_K) (EL 36 W))
                    (word_add (EL 36 sha256_K) (EL 36 W))) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM1; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s110" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WKDC_INNER_9; WKDC_OUTER_9]) THEN
  CUT_POINT_TAC_HW 9 `s110:x86state`;;

(* ========================================================================= *)
(* GROUP10_TAC: symbolic execution of group 10 (steps 111-121) + CUT_POINT 10.*)
(*                                                                           *)
(* Register rotation: cur=XMM5, MSG2_dst=XMM6, ext_dst=XMM3, MSG1_dst=XMM4.  *)
(* (Same rotation as G6.)                                                    *)
(*                                                                           *)
(* Instruction layout (pc+527..pc+575, steps 111-121):                       *)
(*  111: movdqa     xmm0, [rcx+160] — K40..K43 load                          *)
(*  112: paddd      xmm0, xmm5      — K40..K43 + w40..w43                    *)
(*  113: sha256msg2 xmm6, xmm5      — completes w_{44..47} in XMM6           *)
(*  114: sha256rnds2 xmm2, xmm1                                              *)
(*  115: pshufd     xmm0, xmm0, 0x0e                                         *)
(*  116: movdqa     xmm7, xmm6                                               *)
(*  117: palignr    xmm7, xmm5, 4                                            *)
(*  118: nop                                                                  *)
(*  119: paddd      xmm3, xmm7      — schedule extension                      *)
(*  120: sha256msg1 xmm4, xmm5      — starts triple w_{48..51}               *)
(*  121: sha256rnds2 xmm1, xmm2                                              *)
(* ========================================================================= *)

let GROUP10_TAC : tactic =
  let WKDC_OUTER_10 = SPECL
   [`ABEF_PACK (EL 0 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 40 W [a;b;c;d;e;ff;g;h])) :int128`;
    `sha_ni_rnds2
       (CDGH_PACK (EL 2 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
                  (EL 3 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
                  (EL 6 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
                  (EL 7 (sha256_compress 40 W [a;b;c;d;e;ff;g;h])))
       (ABEF_PACK (EL 0 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
                  (EL 1 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
                  (EL 4 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
                  (EL 5 (sha256_compress 40 W [a;b;c;d;e;ff;g;h])))
       (word_join4 (word_add (EL 40 sha256_K) (EL 40 W))
                   (word_add (EL 41 sha256_K) (EL 41 W))
                   (word 0) (word 0)) :int128`;
    `word_add (EL 42 sha256_K) (EL 42 W) :int32`;
    `word_add (EL 43 sha256_K) (EL 43 W) :int32`;
    `word_add (EL 40 sha256_K) (EL 40 W) :int32`;
    `word_add (EL 40 sha256_K) (EL 40 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let WKDC_INNER_10 = SPECL
   [`CDGH_PACK (EL 2 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
               (EL 3 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
               (EL 6 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
               (EL 7 (sha256_compress 40 W [a;b;c;d;e;ff;g;h])) :int128`;
    `ABEF_PACK (EL 0 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 40 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 40 W [a;b;c;d;e;ff;g;h])) :int128`;
    `word_add (EL 40 sha256_K) (EL 40 W) :int32`;
    `word_add (EL 41 sha256_K) (EL 41 W) :int32`;
    `word_add (EL 42 sha256_K) (EL 42 W) :int32`;
    `word_add (EL 43 sha256_K) (EL 43 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let len_h_thm = prove
   (`LENGTH [a:int32;b;c;d;e;ff;g;h] = 8`,
    REWRITE_TAC[LENGTH] THEN ARITH_TAC) in
  let compress_el_shift_9 =
    CONV_RULE(DEPTH_CONV NUM_ADD_CONV)
     (MATCH_MP
        (SPECL [`38`; `W:int32 list`; `[a:int32;b;c;d;e;ff;g;h]`]
               COMPRESS_EL_SHIFT_2)
        len_h_thm) in
  (* Step 111: movdqa xmm0, [rcx+160] (K40..K43) *)
  X86_STEPS_TAC HW_EXEC [111] THEN
  SUBGOAL_THEN
   `read XMM0 s111 = word_join4 (EL 40 sha256_K) (EL 41 sha256_K)
                              (EL 42 sha256_K) (EL 43 sha256_K) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 112: paddd xmm0, xmm5 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s112" THEN PADDD_REFOLD_TAC THEN
  SUBGOAL_THEN
   `read XMM0 s112 =
      word_join4 (word_add (EL 40 sha256_K) (EL 40 W))
                 (word_add (EL 41 sha256_K) (EL 41 W))
                 (word_add (EL 42 sha256_K) (EL 42 W))
                 (word_add (EL 43 sha256_K) (EL 43 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s112" THEN
  (* Step 113: sha256msg2 xmm6, xmm5.  Assert the raw sha_ni_msg2 form, apply
     SHA256MSG2_BRIDGE, then two-phase lane normalization to EL 44..47 W. *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s113" THEN
  FOLD_SHA_NI_MSG2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM6 s113 =
      sha_ni_msg2
        (word_join4
           (word_add (word_add (EL 28 W) (sha256_sigma0 (EL 29 W))) (EL 37 W))
           (word_add (word_add (EL 29 W) (sha256_sigma0 (EL 30 W))) (EL 38 W))
           (word_add (word_add (EL 30 W) (sha256_sigma0 (EL 31 W))) (EL 39 W))
           (word_add (word_add (EL 31 W) (sha256_sigma0 (EL 32 W))) (EL 40 W)))
        (word_join4 (EL 40 W) (EL 41 W) (EL 42 W) (EL 43 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM6; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  UNDISCH_THEN
   ...
   (fun th ->
      ASSUME_TAC(CONV_RULE(RAND_CONV(REWR_CONV SHA256MSG2_BRIDGE THENC
                                     TOP_DEPTH_CONV let_CONV)) th)) THEN
  (* MSG2 output lanes: phase 1 (lanes 0,1 → EL 44/45 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 28 W) (sha256_sigma0 (EL 29 W))) (EL 37 W))
             (sha256_sigma1 (EL 42 W)) :int32 = EL 44 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 29 W) (sha256_sigma0 (EL 30 W))) (EL 38 W))
             (sha256_sigma1 (EL 43 W)) :int32 = EL 45 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 28 W) (sha256_sigma0 (EL 29 W))) (EL 37 W))
             (sha256_sigma1 (EL 42 W)) :int32 = EL 44 W`
   `word_add (word_add (word_add (EL 29 W) (sha256_sigma0 (EL 30 W))) (EL 38 W))
             (sha256_sigma1 (EL 43 W)) :int32 = EL 45 W` THEN
  (* Phase 2 (lanes 2,3 → EL 46/47 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 30 W) (sha256_sigma0 (EL 31 W))) (EL 39 W))
             (sha256_sigma1 (EL 44 W)) :int32 = EL 46 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 31 W) (sha256_sigma0 (EL 32 W))) (EL 40 W))
             (sha256_sigma1 (EL 45 W)) :int32 = EL 47 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 30 W) (sha256_sigma0 (EL 31 W))) (EL 39 W))
             (sha256_sigma1 (EL 44 W)) :int32 = EL 46 W`
   `word_add (word_add (word_add (EL 31 W) (sha256_sigma0 (EL 32 W))) (EL 40 W))
             (sha256_sigma1 (EL 45 W)) :int32 = EL 47 W` THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 2000))) THEN
  DISCARD_OLDSTATE_TAC "s113" THEN
  (* Shift XMM2 from ABEF_PACK (compress 38) to CDGH_PACK (compress 40). *)
  SUBGOAL_THEN
   `read XMM2 s113 = CDGH_PACK
     (EL 2 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))
     (EL 3 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))
     (EL 6 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))
     (EL 7 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[CDGH_EQ_ABEF] THEN
    REWRITE_TAC[compress_el_shift_9]; ALL_TAC] THEN
  UNDISCH_TAC `read XMM2 s113 = ABEF_PACK
     (EL 0 (sha256_compress 38 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 38 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 38 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 38 W [a; b; c; d; e; ff; g; h]))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  (* Step 114: sha256rnds2 xmm2, xmm1 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s114" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  UNDISCH_THEN
   ...
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  UNDISCH_THEN
   `read XMM1 s113 = ABEF_PACK
     (EL 0 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))`
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  ...
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s114" THEN
  (* Step 115: pshufd xmm0, xmm0, 0x0e *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s115" THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM0 s115 =
      word_join4 (word_add (EL 42 sha256_K) (EL 42 W))
                 (word_add (EL 43 sha256_K) (EL 43 W))
                 (word_add (EL 40 sha256_K) (EL 40 W))
                 (word_add (EL 40 sha256_K) (EL 40 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 116: movdqa xmm7, xmm6 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s116" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBGOAL_THEN
   `read XMM7 s116 = word_join4 (EL 44 W) (EL 45 W) (EL 46 W) (EL 47 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s116" THEN
  (* Step 117: palignr xmm7, xmm5, 0x4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s117" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[PALIGNR_4_WORD_JOIN4]) THEN
  SUBGOAL_THEN
   `read XMM7 s117 =
      word_join4 (EL 41 W) (EL 42 W) (EL 43 W) (EL 44 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s117" THEN
  (* Step 118: nop *)
  X86_STEPS_TAC HW_EXEC [118] THEN
  (* Step 119: paddd xmm3, xmm7.  Pre-expand XMM3 s118 from sha_ni_msg1 to raw
     word_join4 via SHA256MSG1_BRIDGE.  XMM3 s110 =
     sha_ni_msg1 (word_join4 EL 32..35 W) (word_join4 EL 36..39 W);
     post-bridge lane j = EL (32+j) W + σ0 (EL (33+j) W).  XMM7 s118 =
     word_join4 (EL 41..44 W).  After PADDD lane j =
     (EL (32+j) W + σ0 (EL (33+j) W)) + EL (j+41) W. *)
  SUBGOAL_THEN
   `read XMM3 s118 =
      word_join4 (word_add (EL 32 W) (sha256_sigma0 (EL 33 W)))
                 (word_add (EL 33 W) (sha256_sigma0 (EL 34 W)))
                 (word_add (EL 34 W) (sha256_sigma0 (EL 35 W)))
                 (word_add (EL 35 W) (sha256_sigma0 (EL 36 W))) :int128`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[SHA256MSG1_BRIDGE]; ALL_TAC] THEN
  UNDISCH_TAC
   `read XMM3 s118 =
      sha_ni_msg1 (word_join4 (EL 32 W) (EL 33 W) (EL 34 W) (EL 35 W))
                  (word_join4 (EL 36 W) (EL 37 W) (EL 38 W) (EL 39 W))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  X86_VERBOSE_STEP_TAC HW_EXEC "s119" THEN PADDD_REFOLD_TAC THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM3 s119 =
      word_join4 (word_add (word_add (EL 32 W) (sha256_sigma0 (EL 33 W))) (EL 41 W))
                 (word_add (word_add (EL 33 W) (sha256_sigma0 (EL 34 W))) (EL 42 W))
                 (word_add (word_add (EL 34 W) (sha256_sigma0 (EL 35 W))) (EL 43 W))
                 (word_add (word_add (EL 35 W) (sha256_sigma0 (EL 36 W))) (EL 44 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM3; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s119" THEN
  (* Step 120: sha256msg1 xmm4, xmm5 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s120" THEN
  FOLD_SHA_NI_MSG1_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM4 s120 =
      sha_ni_msg1 (word_join4 (EL 36 W) (EL 37 W) (EL 38 W) (EL 39 W))
                  (word_join4 (EL 40 W) (EL 41 W) (EL 42 W) (EL 43 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM4; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s120" THEN
  (* Step 121: sha256rnds2 xmm1, xmm2 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s121" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  FIRST_ASSUM(fun th ->
    let s = string_of_term (concl th) in
    if has_sub_string "XMM2 s120 =" s && has_sub_string "sha_ni_rnds2" s
    then RULE_ASSUM_TAC(REWRITE_RULE[th]) else FAIL_TAC "not found") THEN
  UNDISCH_THEN
   `read XMM1 s120 = ABEF_PACK
     (EL 0 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 40 W [a; b; c; d; e; ff; g; h]))`
   ...
   `read XMM1 s121 =
      sha_ni_rnds2
        ...
        (word_join4 (word_add (EL 42 sha256_K) (EL 42 W))
                    (word_add (EL 43 sha256_K) (EL 43 W))
                    (word_add (EL 40 sha256_K) (EL 40 W))
                    (word_add (EL 40 sha256_K) (EL 40 W))) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM1; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s121" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WKDC_INNER_10; WKDC_OUTER_10]) THEN
  CUT_POINT_TAC_HW 10 `s121:x86state`;;

(* ========================================================================= *)
(* GROUP11_TAC: symbolic execution of group 11 (steps 122-132) + CUT_POINT 11.*)
(*                                                                           *)
(* Register rotation: cur=XMM6, MSG2_dst=XMM3, ext_dst=XMM4, MSG1_dst=XMM5.  *)
(* (Same rotation as G7.)                                                    *)
(*                                                                           *)
(* Instruction layout (pc+575..pc+623, steps 122-132):                       *)
(*   122: movdqa     xmm0, [rcx+176] — K44..K47 load                         *)
(*   123: paddd      xmm0, xmm6      — K44..K47 + w44..w47                   *)
(*   124: sha256msg2 xmm3, xmm6      — completes w_{48..51} in XMM3          *)
(*   125: sha256rnds2 xmm2, xmm1                                             *)
(*   126: pshufd     xmm0, xmm0, 0x0e                                        *)
(*   127: movdqa     xmm7, xmm3                                              *)
(*   128: palignr    xmm7, xmm6, 4                                           *)
(*   129: nop                                                                *)
(*   130: paddd      xmm4, xmm7      — schedule extension                    *)
(*   131: sha256msg1 xmm5, xmm6      — starts triple w_{52..55}              *)
(*   132: sha256rnds2 xmm1, xmm2                                             *)
(* ========================================================================= *)

let GROUP11_TAC : tactic =
  let WKDC_OUTER_11 = SPECL
   [`ABEF_PACK (EL 0 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 44 W [a;b;c;d;e;ff;g;h])) :int128`;
    `sha_ni_rnds2
       (CDGH_PACK (EL 2 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
                  (EL 3 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
                  (EL 6 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
                  (EL 7 (sha256_compress 44 W [a;b;c;d;e;ff;g;h])))
       (ABEF_PACK (EL 0 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
                  (EL 1 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
                  (EL 4 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
                  (EL 5 (sha256_compress 44 W [a;b;c;d;e;ff;g;h])))
       (word_join4 (word_add (EL 44 sha256_K) (EL 44 W))
                   (word_add (EL 45 sha256_K) (EL 45 W))
                   (word 0) (word 0)) :int128`;
    `word_add (EL 46 sha256_K) (EL 46 W) :int32`;
    `word_add (EL 47 sha256_K) (EL 47 W) :int32`;
    `word_add (EL 44 sha256_K) (EL 44 W) :int32`;
    `word_add (EL 44 sha256_K) (EL 44 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let WKDC_INNER_11 = SPECL
   [`CDGH_PACK (EL 2 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
               (EL 3 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
               (EL 6 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
               (EL 7 (sha256_compress 44 W [a;b;c;d;e;ff;g;h])) :int128`;
    `ABEF_PACK (EL 0 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 44 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 44 W [a;b;c;d;e;ff;g;h])) :int128`;
    `word_add (EL 44 sha256_K) (EL 44 W) :int32`;
    `word_add (EL 45 sha256_K) (EL 45 W) :int32`;
    `word_add (EL 46 sha256_K) (EL 46 W) :int32`;
    `word_add (EL 47 sha256_K) (EL 47 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let len_h_thm = prove
   (`LENGTH [a:int32;b;c;d;e;ff;g;h] = 8`,
    REWRITE_TAC[LENGTH] THEN ARITH_TAC) in
  let compress_el_shift_10 =
    CONV_RULE(DEPTH_CONV NUM_ADD_CONV)
     (MATCH_MP
        (SPECL [`42`; `W:int32 list`; `[a:int32;b;c;d;e;ff;g;h]`]
               COMPRESS_EL_SHIFT_2)
        len_h_thm) in
  (* Step 78: movdqa xmm0, [rcx+176] (K28..K31) *)
  X86_STEPS_TAC HW_EXEC [122] THEN
  SUBGOAL_THEN
   `read XMM0 s122 = word_join4 (EL 44 sha256_K) (EL 45 sha256_K)
                              (EL 46 sha256_K) (EL 47 sha256_K) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 79: paddd xmm0, xmm6 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s123" THEN PADDD_REFOLD_TAC THEN
  SUBGOAL_THEN
   `read XMM0 s123 =
      word_join4 (word_add (EL 44 sha256_K) (EL 44 W))
                 (word_add (EL 45 sha256_K) (EL 45 W))
                 (word_add (EL 46 sha256_K) (EL 46 W))
                 (word_add (EL 47 sha256_K) (EL 47 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  ...
  (* Step 80: sha256msg2 xmm3, xmm6.  Assert the raw sha_ni_msg2 form, apply
     SHA256MSG2_BRIDGE, then two-phase lane normalization to EL 48..51 W. *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s124" THEN
  FOLD_SHA_NI_MSG2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM3 s124 =
      sha_ni_msg2
        (word_join4
           (word_add (word_add (EL 32 W) (sha256_sigma0 (EL 33 W))) (EL 41 W))
           (word_add (word_add (EL 33 W) (sha256_sigma0 (EL 34 W))) (EL 42 W))
           (word_add (word_add (EL 34 W) (sha256_sigma0 (EL 35 W))) (EL 43 W))
           (word_add (word_add (EL 35 W) (sha256_sigma0 (EL 36 W))) (EL 44 W)))
        (word_join4 (EL 44 W) (EL 45 W) (EL 46 W) (EL 47 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM3; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  UNDISCH_THEN
   ...
   (fun th ->
      ASSUME_TAC(CONV_RULE(RAND_CONV(REWR_CONV SHA256MSG2_BRIDGE THENC
                                     TOP_DEPTH_CONV let_CONV)) th)) THEN
  (* MSG2 output lanes: phase 1 (lanes 0,1 → EL 48/49 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 32 W) (sha256_sigma0 (EL 33 W))) (EL 41 W))
             (sha256_sigma1 (EL 46 W)) :int32 = EL 48 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 33 W) (sha256_sigma0 (EL 34 W))) (EL 42 W))
             (sha256_sigma1 (EL 47 W)) :int32 = EL 49 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 32 W) (sha256_sigma0 (EL 33 W))) (EL 41 W))
             (sha256_sigma1 (EL 46 W)) :int32 = EL 48 W`
   `word_add (word_add (word_add (EL 33 W) (sha256_sigma0 (EL 34 W))) (EL 42 W))
             (sha256_sigma1 (EL 47 W)) :int32 = EL 49 W` THEN
  (* Phase 2 (lanes 2,3 → EL 50/51 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 34 W) (sha256_sigma0 (EL 35 W))) (EL 43 W))
             (sha256_sigma1 (EL 48 W)) :int32 = EL 50 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 35 W) (sha256_sigma0 (EL 36 W))) (EL 44 W))
             (sha256_sigma1 (EL 49 W)) :int32 = EL 51 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 34 W) (sha256_sigma0 (EL 35 W))) (EL 43 W))
             (sha256_sigma1 (EL 48 W)) :int32 = EL 50 W`
   `word_add (word_add (word_add (EL 35 W) (sha256_sigma0 (EL 36 W))) (EL 44 W))
             (sha256_sigma1 (EL 49 W)) :int32 = EL 51 W` THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 2000))) THEN
  DISCARD_OLDSTATE_TAC "s124" THEN
  (* Shift XMM2 from ABEF_PACK (compress 42) to CDGH_PACK (compress 44). *)
  SUBGOAL_THEN
   `read XMM2 s124 = CDGH_PACK
     (EL 2 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))
     (EL 3 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))
     (EL 6 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))
     (EL 7 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[CDGH_EQ_ABEF] THEN
    REWRITE_TAC[compress_el_shift_10]; ALL_TAC] THEN
  UNDISCH_TAC `read XMM2 s124 = ABEF_PACK
     (EL 0 (sha256_compress 42 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 42 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 42 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 42 W [a; b; c; d; e; ff; g; h]))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  (* Step 81: sha256rnds2 xmm2, xmm1 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s125" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  UNDISCH_THEN
   ...
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  UNDISCH_THEN
   `read XMM1 s124 = ABEF_PACK
     (EL 0 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))`
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  ...
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s125" THEN
  (* Step 82: pshufd xmm0, xmm0, 0x0e *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s126" THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM0 s126 =
      word_join4 (word_add (EL 46 sha256_K) (EL 46 W))
                 (word_add (EL 47 sha256_K) (EL 47 W))
                 (word_add (EL 44 sha256_K) (EL 44 W))
                 (word_add (EL 44 sha256_K) (EL 44 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 83: movdqa xmm7, xmm3 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s127" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBGOAL_THEN
   `read XMM7 s127 = word_join4 (EL 48 W) (EL 49 W) (EL 50 W) (EL 51 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s127" THEN
  (* Step 84: palignr xmm7, xmm6, 0x4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s128" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[PALIGNR_4_WORD_JOIN4]) THEN
  SUBGOAL_THEN
   `read XMM7 s128 =
      word_join4 (EL 45 W) (EL 46 W) (EL 47 W) (EL 48 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s128" THEN
  (* Step 85: nop *)
  X86_STEPS_TAC HW_EXEC [129] THEN
  (* Step 86: paddd xmm4, xmm7.  Pre-expand XMM4 s129 from sha_ni_msg1 to raw
     word_join4 via SHA256MSG1_BRIDGE.  XMM4 s77 =
     sha_ni_msg1 (word_join4 EL 36..39 W) (word_join4 EL 40..43 W);
     post-bridge lane j = EL (36+j) W + σ0 (EL (37+j) W).  XMM7 s129 =
     word_join4 (EL 45..48 W).  After PADDD lane j =
     (EL (36+j) W + σ0 (EL (37+j) W)) + EL (j+45) W. *)
  SUBGOAL_THEN
   `read XMM4 s129 =
      word_join4 (word_add (EL 36 W) (sha256_sigma0 (EL 37 W)))
                 (word_add (EL 37 W) (sha256_sigma0 (EL 38 W)))
                 (word_add (EL 38 W) (sha256_sigma0 (EL 39 W)))
                 (word_add (EL 39 W) (sha256_sigma0 (EL 40 W))) :int128`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[SHA256MSG1_BRIDGE]; ALL_TAC] THEN
  UNDISCH_TAC
   `read XMM4 s129 =
      sha_ni_msg1 (word_join4 (EL 36 W) (EL 37 W) (EL 38 W) (EL 39 W))
                  (word_join4 (EL 40 W) (EL 41 W) (EL 42 W) (EL 43 W))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  X86_VERBOSE_STEP_TAC HW_EXEC "s130" THEN PADDD_REFOLD_TAC THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM4 s130 =
      word_join4 (word_add (word_add (EL 36 W) (sha256_sigma0 (EL 37 W))) (EL 45 W))
                 (word_add (word_add (EL 37 W) (sha256_sigma0 (EL 38 W))) (EL 46 W))
                 (word_add (word_add (EL 38 W) (sha256_sigma0 (EL 39 W))) (EL 47 W))
                 (word_add (word_add (EL 39 W) (sha256_sigma0 (EL 40 W))) (EL 48 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM4; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s130" THEN
  (* Step 87: sha256msg1 xmm5, xmm6 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s131" THEN
  FOLD_SHA_NI_MSG1_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM5 s131 =
      sha_ni_msg1 (word_join4 (EL 40 W) (EL 41 W) (EL 42 W) (EL 43 W))
                  (word_join4 (EL 44 W) (EL 45 W) (EL 46 W) (EL 47 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM5; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s131" THEN
  (* Step 88: sha256rnds2 xmm1, xmm2 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s132" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  FIRST_ASSUM(fun th ->
    let s = string_of_term (concl th) in
    if has_sub_string "XMM2 s131 =" s && has_sub_string "sha_ni_rnds2" s
    then RULE_ASSUM_TAC(REWRITE_RULE[th]) else FAIL_TAC "not found") THEN
  UNDISCH_THEN
   `read XMM1 s131 = ABEF_PACK
     (EL 0 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 44 W [a; b; c; d; e; ff; g; h]))`
   ...
   `read XMM1 s132 =
      sha_ni_rnds2
        ...
        (word_join4 (word_add (EL 46 sha256_K) (EL 46 W))
                    (word_add (EL 47 sha256_K) (EL 47 W))
                    (word_add (EL 44 sha256_K) (EL 44 W))
                    (word_add (EL 44 sha256_K) (EL 44 W))) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM1; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s132" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WKDC_INNER_11; WKDC_OUTER_11]) THEN
  CUT_POINT_TAC_HW 11 `s132:x86state`;;

(* ========================================================================= *)
(* GROUP12_TAC: symbolic execution of group 12 (steps 133-143) + CUT_POINT 12.*)
(*                                                                           *)
(* Register rotation: cur=XMM3, MSG2_dst=XMM4, ext_dst=XMM5, MSG1_dst=XMM6.  *)
(* (Same rotation as G8, G4.)                                                *)
(*                                                                           *)
(* Instruction layout (pc+623..pc+671, steps 133-143):                       *)
(*   133: movdqa     xmm0, [rcx+192] — K48..K51 load                         *)
(*   134: paddd      xmm0, xmm3      — K48..K51 + w48..w51                   *)
(*   135: sha256msg2 xmm4, xmm3      — completes w_{52..55} in XMM4          *)
(*   136: sha256rnds2 xmm2, xmm1                                             *)
(*   137: pshufd     xmm0, xmm0, 0x0e                                        *)
(*   138: movdqa     xmm7, xmm4                                              *)
(*   139: palignr    xmm7, xmm3, 4                                           *)
(*   140: nop                                                                *)
(*   141: paddd      xmm5, xmm7      — schedule extension                    *)
(*   142: sha256msg1 xmm6, xmm3      — starts triple w_{56..59}              *)
(*   143: sha256rnds2 xmm1, xmm2                                             *)
(* ========================================================================= *)

let GROUP12_TAC : tactic =
  let WKDC_OUTER_12 = SPECL
   [`ABEF_PACK (EL 0 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 48 W [a;b;c;d;e;ff;g;h])) :int128`;
    `sha_ni_rnds2
       (CDGH_PACK (EL 2 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
                  (EL 3 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
                  (EL 6 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
                  (EL 7 (sha256_compress 48 W [a;b;c;d;e;ff;g;h])))
       (ABEF_PACK (EL 0 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
                  (EL 1 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
                  (EL 4 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
                  (EL 5 (sha256_compress 48 W [a;b;c;d;e;ff;g;h])))
       (word_join4 (word_add (EL 48 sha256_K) (EL 48 W))
                   (word_add (EL 49 sha256_K) (EL 49 W))
                   (word 0) (word 0)) :int128`;
    `word_add (EL 50 sha256_K) (EL 50 W) :int32`;
    `word_add (EL 51 sha256_K) (EL 51 W) :int32`;
    `word_add (EL 48 sha256_K) (EL 48 W) :int32`;
    `word_add (EL 48 sha256_K) (EL 48 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let WKDC_INNER_12 = SPECL
   [`CDGH_PACK (EL 2 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
               (EL 3 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
               (EL 6 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
               (EL 7 (sha256_compress 48 W [a;b;c;d;e;ff;g;h])) :int128`;
    `ABEF_PACK (EL 0 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 48 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 48 W [a;b;c;d;e;ff;g;h])) :int128`;
    `word_add (EL 48 sha256_K) (EL 48 W) :int32`;
    `word_add (EL 49 sha256_K) (EL 49 W) :int32`;
    `word_add (EL 50 sha256_K) (EL 50 W) :int32`;
    `word_add (EL 51 sha256_K) (EL 51 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let len_h_thm = prove
   (`LENGTH [a:int32;b;c;d;e;ff;g;h] = 8`,
    REWRITE_TAC[LENGTH] THEN ARITH_TAC) in
  let compress_el_shift_11 =
    CONV_RULE(DEPTH_CONV NUM_ADD_CONV)
     (MATCH_MP
        (SPECL [`46`; `W:int32 list`; `[a:int32;b;c;d;e;ff;g;h]`]
               COMPRESS_EL_SHIFT_2)
        len_h_thm) in
  (* Step 89: movdqa xmm0, [rcx+192] (K32..K35) *)
  X86_STEPS_TAC HW_EXEC [133] THEN
  SUBGOAL_THEN
   `read XMM0 s133 = word_join4 (EL 48 sha256_K) (EL 49 sha256_K)
                              (EL 50 sha256_K) (EL 51 sha256_K) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 90: paddd xmm0, xmm3 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s134" THEN PADDD_REFOLD_TAC THEN
  SUBGOAL_THEN
   `read XMM0 s134 =
      word_join4 (word_add (EL 48 sha256_K) (EL 48 W))
                 (word_add (EL 49 sha256_K) (EL 49 W))
                 (word_add (EL 50 sha256_K) (EL 50 W))
                 (word_add (EL 51 sha256_K) (EL 51 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s134" THEN
  (* Step 91: sha256msg2 xmm4, xmm3.  Assert the raw sha_ni_msg2 form, apply
     SHA256MSG2_BRIDGE, then two-phase lane normalization to EL 52..55 W. *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s135" THEN
  FOLD_SHA_NI_MSG2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM4 s135 =
      sha_ni_msg2
        (word_join4
           (word_add (word_add (EL 36 W) (sha256_sigma0 (EL 37 W))) (EL 45 W))
           (word_add (word_add (EL 37 W) (sha256_sigma0 (EL 38 W))) (EL 46 W))
           (word_add (word_add (EL 38 W) (sha256_sigma0 (EL 39 W))) (EL 47 W))
           (word_add (word_add (EL 39 W) (sha256_sigma0 (EL 40 W))) (EL 48 W)))
        (word_join4 (EL 48 W) (EL 49 W) (EL 50 W) (EL 51 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM4; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  UNDISCH_THEN
   ...
   (fun th ->
      ASSUME_TAC(CONV_RULE(RAND_CONV(REWR_CONV SHA256MSG2_BRIDGE THENC
                                     TOP_DEPTH_CONV let_CONV)) th)) THEN
  (* MSG2 output lanes: phase 1 (lanes 0,1 → EL 52/53 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 36 W) (sha256_sigma0 (EL 37 W))) (EL 45 W))
             (sha256_sigma1 (EL 50 W)) :int32 = EL 52 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 37 W) (sha256_sigma0 (EL 38 W))) (EL 46 W))
             (sha256_sigma1 (EL 51 W)) :int32 = EL 53 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 36 W) (sha256_sigma0 (EL 37 W))) (EL 45 W))
             (sha256_sigma1 (EL 50 W)) :int32 = EL 52 W`
   `word_add (word_add (word_add (EL 37 W) (sha256_sigma0 (EL 38 W))) (EL 46 W))
             (sha256_sigma1 (EL 51 W)) :int32 = EL 53 W` THEN
  (* Phase 2 (lanes 2,3 → EL 54/55 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 38 W) (sha256_sigma0 (EL 39 W))) (EL 47 W))
             (sha256_sigma1 (EL 52 W)) :int32 = EL 54 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 39 W) (sha256_sigma0 (EL 40 W))) (EL 48 W))
             (sha256_sigma1 (EL 53 W)) :int32 = EL 55 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 38 W) (sha256_sigma0 (EL 39 W))) (EL 47 W))
             (sha256_sigma1 (EL 52 W)) :int32 = EL 54 W`
   `word_add (word_add (word_add (EL 39 W) (sha256_sigma0 (EL 40 W))) (EL 48 W))
             (sha256_sigma1 (EL 53 W)) :int32 = EL 55 W` THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 2000))) THEN
  DISCARD_OLDSTATE_TAC "s135" THEN
  (* Shift XMM2 from ABEF_PACK (compress 46) to CDGH_PACK (compress 48). *)
  SUBGOAL_THEN
   `read XMM2 s135 = CDGH_PACK
     (EL 2 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))
     (EL 3 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))
     (EL 6 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))
     (EL 7 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[CDGH_EQ_ABEF] THEN
    REWRITE_TAC[compress_el_shift_11]; ALL_TAC] THEN
  UNDISCH_TAC `read XMM2 s135 = ABEF_PACK
     (EL 0 (sha256_compress 46 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 46 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 46 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 46 W [a; b; c; d; e; ff; g; h]))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  (* Step 92: sha256rnds2 xmm2, xmm1 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s136" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  UNDISCH_THEN
   ...
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  UNDISCH_THEN
   `read XMM1 s135 = ABEF_PACK
     (EL 0 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))`
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  ...
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s136" THEN
  (* Step 93: pshufd xmm0, xmm0, 0x0e *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s137" THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM0 s137 =
      word_join4 (word_add (EL 50 sha256_K) (EL 50 W))
                 (word_add (EL 51 sha256_K) (EL 51 W))
                 (word_add (EL 48 sha256_K) (EL 48 W))
                 (word_add (EL 48 sha256_K) (EL 48 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 94: movdqa xmm7, xmm4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s138" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBGOAL_THEN
   `read XMM7 s138 = word_join4 (EL 52 W) (EL 53 W) (EL 54 W) (EL 55 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s138" THEN
  (* Step 95: palignr xmm7, xmm3, 0x4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s139" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[PALIGNR_4_WORD_JOIN4]) THEN
  SUBGOAL_THEN
   `read XMM7 s139 =
      word_join4 (EL 49 W) (EL 50 W) (EL 51 W) (EL 52 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s139" THEN
  (* Step 96: nop *)
  X86_STEPS_TAC HW_EXEC [140] THEN
  (* Step 97: paddd xmm5, xmm7.  Pre-expand XMM5 s140 from sha_ni_msg1 to raw
     word_join4 via SHA256MSG1_BRIDGE.  XMM5 s88 =
     sha_ni_msg1 (word_join4 EL 40..43 W) (word_join4 EL 44..47 W);
     post-bridge lane j = EL (40+j) W + σ0 (EL (41+j) W).  XMM7 s140 =
     word_join4 (EL 49..52 W).  After PADDD lane j =
     (EL (40+j) W + σ0 (EL (41+j) W)) + EL (j+49) W. *)
  SUBGOAL_THEN
   `read XMM5 s140 =
      word_join4 (word_add (EL 40 W) (sha256_sigma0 (EL 41 W)))
                 (word_add (EL 41 W) (sha256_sigma0 (EL 42 W)))
                 (word_add (EL 42 W) (sha256_sigma0 (EL 43 W)))
                 (word_add (EL 43 W) (sha256_sigma0 (EL 44 W))) :int128`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[SHA256MSG1_BRIDGE]; ALL_TAC] THEN
  UNDISCH_TAC
   `read XMM5 s140 =
      sha_ni_msg1 (word_join4 (EL 40 W) (EL 41 W) (EL 42 W) (EL 43 W))
                  (word_join4 (EL 44 W) (EL 45 W) (EL 46 W) (EL 47 W))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  X86_VERBOSE_STEP_TAC HW_EXEC "s141" THEN PADDD_REFOLD_TAC THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM5 s141 =
      word_join4 (word_add (word_add (EL 40 W) (sha256_sigma0 (EL 41 W))) (EL 49 W))
                 (word_add (word_add (EL 41 W) (sha256_sigma0 (EL 42 W))) (EL 50 W))
                 (word_add (word_add (EL 42 W) (sha256_sigma0 (EL 43 W))) (EL 51 W))
                 (word_add (word_add (EL 43 W) (sha256_sigma0 (EL 44 W))) (EL 52 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM5; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s141" THEN
  (* Step 98: sha256msg1 xmm6, xmm3 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s142" THEN
  FOLD_SHA_NI_MSG1_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM6 s142 =
      sha_ni_msg1 (word_join4 (EL 44 W) (EL 45 W) (EL 46 W) (EL 47 W))
                  (word_join4 (EL 48 W) (EL 49 W) (EL 50 W) (EL 51 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM6; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s142" THEN
  (* Step 99: sha256rnds2 xmm1, xmm2 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s143" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  FIRST_ASSUM(fun th ->
    let s = string_of_term (concl th) in
    if has_sub_string "XMM2 s142 =" s && has_sub_string "sha_ni_rnds2" s
    then RULE_ASSUM_TAC(REWRITE_RULE[th]) else FAIL_TAC "not found") THEN
  UNDISCH_THEN
   `read XMM1 s142 = ABEF_PACK
     (EL 0 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 48 W [a; b; c; d; e; ff; g; h]))`
   ...
   `read XMM1 s143 =
      sha_ni_rnds2
        ...
        (word_join4 (word_add (EL 50 sha256_K) (EL 50 W))
                    (word_add (EL 51 sha256_K) (EL 51 W))
                    (word_add (EL 48 sha256_K) (EL 48 W))
                    (word_add (EL 48 sha256_K) (EL 48 W))) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM1; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s143" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WKDC_INNER_12; WKDC_OUTER_12]) THEN
  CUT_POINT_TAC_HW 12 `s143:x86state`;;

(* ========================================================================= *)
(* GROUP13_TAC: symbolic execution of group 13 (steps 144-152) + CUT_POINT 13.*)
(*                                                                           *)
(* G13 diverges from the G4..G12 steady-state pattern:                       *)
(*   - 9 steps instead of 11 (no NOP, no final SHA256MSG1)                   *)
(*   - the order of the last two ops is swapped: RNDS2 comes BEFORE          *)
(*     the final ext PADDD                                                   *)
(*                                                                           *)
(* This is because the schedule only needs w_0..w_63; G12's SHA256MSG1       *)
(* already started the final triple (w_{56..59}), so G13 doesn't need to     *)
(* start another one.  G14 will still execute its own SHA256MSG2 to close   *)
(* G12's triple.                                                             *)
(*                                                                           *)
(* Register rotation: cur=XMM4, MSG2_dst=XMM5, ext_dst=XMM6.                 *)
(*                                                                           *)
(* Instruction layout (pc+671..pc+714, steps 144-152):                       *)
(*   144: movdqa     xmm0, [rcx+208] — K52..K55 load                         *)
(*   145: paddd      xmm0, xmm4      — K52..K55 + w52..w55                   *)
(*   146: sha256msg2 xmm5, xmm4      — completes w_{56..59} in XMM5          *)
(*   147: sha256rnds2 xmm2, xmm1                                             *)
(*   148: pshufd     xmm0, xmm0, 0x0e                                        *)
(*   149: movdqa     xmm7, xmm5                                              *)
(*   150: palignr    xmm7, xmm4, 4                                           *)
(*   151: sha256rnds2 xmm1, xmm2                                             *)
(*   152: paddd      xmm6, xmm7      — schedule extension (no MSG1 after)    *)
(* ========================================================================= *)

let GROUP13_TAC : tactic =
  let WKDC_OUTER_13 = SPECL
   [`ABEF_PACK (EL 0 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 52 W [a;b;c;d;e;ff;g;h])) :int128`;
    `sha_ni_rnds2
       (CDGH_PACK (EL 2 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
                  (EL 3 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
                  (EL 6 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
                  (EL 7 (sha256_compress 52 W [a;b;c;d;e;ff;g;h])))
       (ABEF_PACK (EL 0 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
                  (EL 1 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
                  (EL 4 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
                  (EL 5 (sha256_compress 52 W [a;b;c;d;e;ff;g;h])))
       (word_join4 (word_add (EL 52 sha256_K) (EL 52 W))
                   (word_add (EL 53 sha256_K) (EL 53 W))
                   (word 0) (word 0)) :int128`;
    `word_add (EL 54 sha256_K) (EL 54 W) :int32`;
    `word_add (EL 55 sha256_K) (EL 55 W) :int32`;
    `word_add (EL 52 sha256_K) (EL 52 W) :int32`;
    `word_add (EL 52 sha256_K) (EL 52 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let WKDC_INNER_13 = SPECL
   [`CDGH_PACK (EL 2 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
               (EL 3 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
               (EL 6 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
               (EL 7 (sha256_compress 52 W [a;b;c;d;e;ff;g;h])) :int128`;
    `ABEF_PACK (EL 0 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 52 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 52 W [a;b;c;d;e;ff;g;h])) :int128`;
    `word_add (EL 52 sha256_K) (EL 52 W) :int32`;
    `word_add (EL 53 sha256_K) (EL 53 W) :int32`;
    `word_add (EL 54 sha256_K) (EL 54 W) :int32`;
    `word_add (EL 55 sha256_K) (EL 55 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let len_h_thm = prove
   (`LENGTH [a:int32;b;c;d;e;ff;g;h] = 8`,
    REWRITE_TAC[LENGTH] THEN ARITH_TAC) in
  let compress_el_shift_12 =
    CONV_RULE(DEPTH_CONV NUM_ADD_CONV)
     (MATCH_MP
        (SPECL [`50`; `W:int32 list`; `[a:int32;b;c;d;e;ff;g;h]`]
               COMPRESS_EL_SHIFT_2)
        len_h_thm) in
  (* Step 144: movdqa xmm0, [rcx+208] (K52..K55) *)
  X86_STEPS_TAC HW_EXEC [144] THEN
  SUBGOAL_THEN
   `read XMM0 s144 = word_join4 (EL 52 sha256_K) (EL 53 sha256_K)
                              (EL 54 sha256_K) (EL 55 sha256_K) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 145: paddd xmm0, xmm4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s145" THEN PADDD_REFOLD_TAC THEN
  SUBGOAL_THEN
   `read XMM0 s145 =
      word_join4 (word_add (EL 52 sha256_K) (EL 52 W))
                 (word_add (EL 53 sha256_K) (EL 53 W))
                 (word_add (EL 54 sha256_K) (EL 54 W))
                 (word_add (EL 55 sha256_K) (EL 55 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s145" THEN
  (* Step 146: sha256msg2 xmm5, xmm4.  Assert the raw sha_ni_msg2 form, apply
     SHA256MSG2_BRIDGE, then two-phase lane normalization to EL 56..59 W. *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s146" THEN
  FOLD_SHA_NI_MSG2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM5 s146 =
      sha_ni_msg2
        (word_join4
           (word_add (word_add (EL 40 W) (sha256_sigma0 (EL 41 W))) (EL 49 W))
           (word_add (word_add (EL 41 W) (sha256_sigma0 (EL 42 W))) (EL 50 W))
           (word_add (word_add (EL 42 W) (sha256_sigma0 (EL 43 W))) (EL 51 W))
           (word_add (word_add (EL 43 W) (sha256_sigma0 (EL 44 W))) (EL 52 W)))
        (word_join4 (EL 52 W) (EL 53 W) (EL 54 W) (EL 55 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM5; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  UNDISCH_THEN
   ...
   (fun th ->
      ASSUME_TAC(CONV_RULE(RAND_CONV(REWR_CONV SHA256MSG2_BRIDGE THENC
                                     TOP_DEPTH_CONV let_CONV)) th)) THEN
  (* MSG2 output lanes: phase 1 (lanes 0,1 → EL 56/57 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 40 W) (sha256_sigma0 (EL 41 W))) (EL 49 W))
             (sha256_sigma1 (EL 54 W)) :int32 = EL 56 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 41 W) (sha256_sigma0 (EL 42 W))) (EL 50 W))
             (sha256_sigma1 (EL 55 W)) :int32 = EL 57 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 40 W) (sha256_sigma0 (EL 41 W))) (EL 49 W))
             (sha256_sigma1 (EL 54 W)) :int32 = EL 56 W`
   `word_add (word_add (word_add (EL 41 W) (sha256_sigma0 (EL 42 W))) (EL 50 W))
             (sha256_sigma1 (EL 55 W)) :int32 = EL 57 W` THEN
  (* Phase 2 (lanes 2,3 → EL 58/59 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 42 W) (sha256_sigma0 (EL 43 W))) (EL 51 W))
             (sha256_sigma1 (EL 56 W)) :int32 = EL 58 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 43 W) (sha256_sigma0 (EL 44 W))) (EL 52 W))
             (sha256_sigma1 (EL 57 W)) :int32 = EL 59 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 42 W) (sha256_sigma0 (EL 43 W))) (EL 51 W))
             (sha256_sigma1 (EL 56 W)) :int32 = EL 58 W`
   `word_add (word_add (word_add (EL 43 W) (sha256_sigma0 (EL 44 W))) (EL 52 W))
             (sha256_sigma1 (EL 57 W)) :int32 = EL 59 W` THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 2000))) THEN
  DISCARD_OLDSTATE_TAC "s146" THEN
  (* Shift XMM2 from ABEF_PACK (compress 50) to CDGH_PACK (compress 52). *)
  SUBGOAL_THEN
   `read XMM2 s146 = CDGH_PACK
     (EL 2 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))
     (EL 3 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))
     (EL 6 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))
     (EL 7 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[CDGH_EQ_ABEF] THEN
    REWRITE_TAC[compress_el_shift_12]; ALL_TAC] THEN
  UNDISCH_TAC `read XMM2 s146 = ABEF_PACK
     (EL 0 (sha256_compress 50 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 50 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 50 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 50 W [a; b; c; d; e; ff; g; h]))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  (* Step 147: sha256rnds2 xmm2, xmm1 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s147" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  UNDISCH_THEN
   ...
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  UNDISCH_THEN
   `read XMM1 s146 = ABEF_PACK
     (EL 0 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))`
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  ...
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s147" THEN
  (* Step 148: pshufd xmm0, xmm0, 0x0e *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s148" THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM0 s148 =
      word_join4 (word_add (EL 54 sha256_K) (EL 54 W))
                 (word_add (EL 55 sha256_K) (EL 55 W))
                 (word_add (EL 52 sha256_K) (EL 52 W))
                 (word_add (EL 52 sha256_K) (EL 52 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 149: movdqa xmm7, xmm5 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s149" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBGOAL_THEN
   `read XMM7 s149 = word_join4 (EL 56 W) (EL 57 W) (EL 58 W) (EL 59 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s149" THEN
  (* Step 150: palignr xmm7, xmm4, 0x4 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s150" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[PALIGNR_4_WORD_JOIN4]) THEN
  SUBGOAL_THEN
   `read XMM7 s150 =
      word_join4 (EL 53 W) (EL 54 W) (EL 55 W) (EL 56 W) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s150" THEN
  (* Step 151: sha256rnds2 xmm1, xmm2.  Done BEFORE the final PADDD (G13
     divergence from the G4..G12 template, where MSG1 came before this RNDS2
     and the ext-PADDD came after step 119 instead of after step 151). *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s151" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  FIRST_ASSUM(fun th ->
    let s = string_of_term (concl th) in
    if has_sub_string "XMM2 s150 =" s && has_sub_string "sha_ni_rnds2" s
    then RULE_ASSUM_TAC(REWRITE_RULE[th]) else FAIL_TAC "not found") THEN
  UNDISCH_THEN
   `read XMM1 s150 = ABEF_PACK
     (EL 0 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 52 W [a; b; c; d; e; ff; g; h]))`
   ...
   `read XMM1 s151 =
      sha_ni_rnds2
        ...
        (word_join4 (word_add (EL 54 sha256_K) (EL 54 W))
                    (word_add (EL 55 sha256_K) (EL 55 W))
                    (word_add (EL 52 sha256_K) (EL 52 W))
                    (word_add (EL 52 sha256_K) (EL 52 W))) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM1; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s151" THEN
  (* Step 152: paddd xmm6, xmm7.  Pre-expand XMM6 s151 from sha_ni_msg1 to
     raw word_join4 via SHA256MSG1_BRIDGE.  XMM6 s131 is
     sha_ni_msg1 (word_join4 EL 44..47 W) (word_join4 EL 48..51 W) from G11;
     post-bridge lane j = EL (44+j) W + σ0 (EL (45+j) W).  XMM7 s150 =
     word_join4 (EL 53..56 W).  After PADDD lane j =
     (EL (44+j) W + σ0 (EL (45+j) W)) + EL (j+53) W.  There is no SHA256MSG1
     after this step — the schedule is fully extended once G14's MSG2 closes
     G12's open triple. *)
  SUBGOAL_THEN
   `read XMM6 s151 =
      word_join4 (word_add (EL 44 W) (sha256_sigma0 (EL 45 W)))
                 (word_add (EL 45 W) (sha256_sigma0 (EL 46 W)))
                 (word_add (EL 46 W) (sha256_sigma0 (EL 47 W)))
                 (word_add (EL 47 W) (sha256_sigma0 (EL 48 W))) :int128`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[SHA256MSG1_BRIDGE]; ALL_TAC] THEN
  UNDISCH_TAC
   `read XMM6 s151 =
      sha_ni_msg1 (word_join4 (EL 44 W) (EL 45 W) (EL 46 W) (EL 47 W))
                  (word_join4 (EL 48 W) (EL 49 W) (EL 50 W) (EL 51 W))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  X86_VERBOSE_STEP_TAC HW_EXEC "s152" THEN PADDD_REFOLD_TAC THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM6 s152 =
      word_join4 (word_add (word_add (EL 44 W) (sha256_sigma0 (EL 45 W))) (EL 53 W))
                 (word_add (word_add (EL 45 W) (sha256_sigma0 (EL 46 W))) (EL 54 W))
                 (word_add (word_add (EL 46 W) (sha256_sigma0 (EL 47 W))) (EL 55 W))
                 (word_add (word_add (EL 47 W) (sha256_sigma0 (EL 48 W))) (EL 56 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM6; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s152" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WKDC_INNER_13; WKDC_OUTER_13]) THEN
  CUT_POINT_TAC_HW 13 `s152:x86state`;;

(* ========================================================================= *)
(* GROUP14_TAC: symbolic execution of group 14 (steps 153-159) + CUT_POINT 14.*)
(*                                                                           *)
(* G14 diverges even further from the G4..G13 template:                      *)
(*   - 7 steps instead of 9/11 (no NOP, no PALIGNR, no MSG1, no ext PADDD)   *)
(*   - MSG2 comes AFTER the first RNDS2 (not before)                         *)
(*   - `movdqa xmm7, xmm8` preloads the pshufb mask for the post-loop        *)
(*     byteswap (replaces the usual palignr xmm7 slot)                       *)
(*   - The first RNDS2 runs BEFORE the PSHUFD, so its wk has all 4 K+W lanes *)
(*     populated; WKDC_INNER_14 absorbs the lanes-2/3 don't-care             *)
(*                                                                           *)
(* Register rotation: cur=XMM5, MSG2_dst=XMM6.  No ext_dst, no MSG1_dst.     *)
(*                                                                           *)
(* Instruction layout (pc+714..pc+748, steps 153-159):                       *)
(*   153: movdqa     xmm0, [rcx+224] — K56..K59 load                         *)
(*   154: paddd      xmm0, xmm5      — K56..K59 + w56..w59                   *)
(*   155: sha256rnds2 xmm2, xmm1     — 1st RNDS2 (BEFORE PSHUFD)             *)
(*   156: pshufd     xmm0, xmm0, 0x0e                                        *)
(*   157: sha256msg2 xmm6, xmm5      — closes final triple in XMM6           *)
(*                                     (XMM6 becomes word_join4 EL 60..63 W) *)
(*   158: movdqa     xmm7, xmm8      — pshufb mask reload                    *)
(*   159: sha256rnds2 xmm1, xmm2                                             *)
(* ========================================================================= *)

let GROUP14_TAC : tactic =
  let WKDC_OUTER_14 = SPECL
   [`ABEF_PACK (EL 0 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 56 W [a;b;c;d;e;ff;g;h])) :int128`;
    `sha_ni_rnds2
       (CDGH_PACK (EL 2 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
                  (EL 3 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
                  (EL 6 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
                  (EL 7 (sha256_compress 56 W [a;b;c;d;e;ff;g;h])))
       (ABEF_PACK (EL 0 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
                  (EL 1 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
                  (EL 4 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
                  (EL 5 (sha256_compress 56 W [a;b;c;d;e;ff;g;h])))
       (word_join4 (word_add (EL 56 sha256_K) (EL 56 W))
                   (word_add (EL 57 sha256_K) (EL 57 W))
                   (word 0) (word 0)) :int128`;
    `word_add (EL 58 sha256_K) (EL 58 W) :int32`;
    `word_add (EL 59 sha256_K) (EL 59 W) :int32`;
    `word_add (EL 56 sha256_K) (EL 56 W) :int32`;
    `word_add (EL 56 sha256_K) (EL 56 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let WKDC_INNER_14 = SPECL
   [`CDGH_PACK (EL 2 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
               (EL 3 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
               (EL 6 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
               (EL 7 (sha256_compress 56 W [a;b;c;d;e;ff;g;h])) :int128`;
    `ABEF_PACK (EL 0 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 56 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 56 W [a;b;c;d;e;ff;g;h])) :int128`;
    `word_add (EL 56 sha256_K) (EL 56 W) :int32`;
    `word_add (EL 57 sha256_K) (EL 57 W) :int32`;
    `word_add (EL 58 sha256_K) (EL 58 W) :int32`;
    `word_add (EL 59 sha256_K) (EL 59 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let len_h_thm = prove
   (`LENGTH [a:int32;b;c;d;e;ff;g;h] = 8`,
    REWRITE_TAC[LENGTH] THEN ARITH_TAC) in
  let compress_el_shift_13 =
    CONV_RULE(DEPTH_CONV NUM_ADD_CONV)
     (MATCH_MP
        (SPECL [`54`; `W:int32 list`; `[a:int32;b;c;d;e;ff;g;h]`]
               COMPRESS_EL_SHIFT_2)
        len_h_thm) in
  (* Step 153: movdqa xmm0, [rcx+224] (K56..K59) *)
  X86_STEPS_TAC HW_EXEC [153] THEN
  SUBGOAL_THEN
   `read XMM0 s153 = word_join4 (EL 56 sha256_K) (EL 57 sha256_K)
                              (EL 58 sha256_K) (EL 59 sha256_K) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 154: paddd xmm0, xmm5 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s154" THEN PADDD_REFOLD_TAC THEN
  SUBGOAL_THEN
   `read XMM0 s154 =
      word_join4 (word_add (EL 56 sha256_K) (EL 56 W))
                 (word_add (EL 57 sha256_K) (EL 57 W))
                 (word_add (EL 58 sha256_K) (EL 58 W))
                 (word_add (EL 59 sha256_K) (EL 59 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s154" THEN
  (* Shift XMM2 from ABEF_PACK (compress 54) to CDGH_PACK (compress 56) —
     done BEFORE step 155 RNDS2 since no MSG2 precedes it in G14. *)
  SUBGOAL_THEN
   `read XMM2 s154 = CDGH_PACK
     (EL 2 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))
     (EL 3 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))
     (EL 6 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))
     (EL 7 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[CDGH_EQ_ABEF] THEN
    REWRITE_TAC[compress_el_shift_13]; ALL_TAC] THEN
  UNDISCH_TAC `read XMM2 s154 = ABEF_PACK
     (EL 0 (sha256_compress 54 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 54 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 54 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 54 W [a; b; c; d; e; ff; g; h]))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  (* Step 155: sha256rnds2 xmm2, xmm1 (1st RNDS2 BEFORE PSHUFD — all 4 wk
     lanes present, but RNDS2 only uses lanes 0,1; WKDC_INNER_14 absorbs
     the lanes-2,3 don't-care). *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s155" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  UNDISCH_THEN
   ...
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  UNDISCH_THEN
   `read XMM1 s154 = ABEF_PACK
     (EL 0 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))`
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  ...
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s155" THEN
  (* Step 156: pshufd xmm0, xmm0, 0x0e *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s156" THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM0 s156 =
      word_join4 (word_add (EL 58 sha256_K) (EL 58 W))
                 (word_add (EL 59 sha256_K) (EL 59 W))
                 (word_add (EL 56 sha256_K) (EL 56 W))
                 (word_add (EL 56 sha256_K) (EL 56 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 157: sha256msg2 xmm6, xmm5.  Closes the final triple.  XMM6 s156
     is the partial `word_join4 (w_{44+j}+σ0 w_{45+j}+EL(j+53)W)` from G13
     step 152 — already in raw word_join4 form, no MSG1_BRIDGE pre-expansion
     needed.  XMM5 s156 = word_join4 (EL 56..59 W).
     Expected output: word_join4 (EL 60 W) (EL 61 W) (EL 62 W) (EL 63 W). *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s157" THEN
  FOLD_SHA_NI_MSG2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  SUBGOAL_THEN
   `read XMM6 s157 =
      sha_ni_msg2
        (word_join4
           (word_add (word_add (EL 44 W) (sha256_sigma0 (EL 45 W))) (EL 53 W))
           (word_add (word_add (EL 45 W) (sha256_sigma0 (EL 46 W))) (EL 54 W))
           (word_add (word_add (EL 46 W) (sha256_sigma0 (EL 47 W))) (EL 55 W))
           (word_add (word_add (EL 47 W) (sha256_sigma0 (EL 48 W))) (EL 56 W)))
        (word_join4 (EL 56 W) (EL 57 W) (EL 58 W) (EL 59 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM6; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  UNDISCH_THEN
   ...
   (fun th ->
      ASSUME_TAC(CONV_RULE(RAND_CONV(REWR_CONV SHA256MSG2_BRIDGE THENC
                                     TOP_DEPTH_CONV let_CONV)) th)) THEN
  (* MSG2 output lanes phase 1 (lanes 0,1 → EL 60/61 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 44 W) (sha256_sigma0 (EL 45 W))) (EL 53 W))
             (sha256_sigma1 (EL 58 W)) :int32 = EL 60 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 45 W) (sha256_sigma0 (EL 46 W))) (EL 54 W))
             (sha256_sigma1 (EL 59 W)) :int32 = EL 61 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 44 W) (sha256_sigma0 (EL 45 W))) (EL 53 W))
             (sha256_sigma1 (EL 58 W)) :int32 = EL 60 W`
   `word_add (word_add (word_add (EL 45 W) (sha256_sigma0 (EL 46 W))) (EL 54 W))
             (sha256_sigma1 (EL 59 W)) :int32 = EL 61 W` THEN
  (* Phase 2 (lanes 2,3 → EL 62/63 W). *)
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 46 W) (sha256_sigma0 (EL 47 W))) (EL 55 W))
             (sha256_sigma1 (EL 60 W)) :int32 = EL 62 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  SUBGOAL_THEN
   `word_add (word_add (word_add (EL 47 W) (sha256_sigma0 (EL 48 W))) (EL 56 W))
             (sha256_sigma1 (EL 61 W)) :int32 = EL 63 W`
   ASSUME_TAC THENL [PROVE_LANE_EQ_TAC; ALL_TAC] THEN
  APPLY_TWO_EQS_TAC
   `word_add (word_add (word_add (EL 46 W) (sha256_sigma0 (EL 47 W))) (EL 55 W))
             (sha256_sigma1 (EL 60 W)) :int32 = EL 62 W`
   `word_add (word_add (word_add (EL 47 W) (sha256_sigma0 (EL 48 W))) (EL 56 W))
             (sha256_sigma1 (EL 61 W)) :int32 = EL 63 W` THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 2000))) THEN
  DISCARD_OLDSTATE_TAC "s157" THEN
  (* Step 158: movdqa xmm7, xmm8 — reload the pshufb mask for post-loop
     byteswap.  XMM8 s157 = pshufb_mask_val is in the assumption list as
     a clean form (never ghosted). *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s158" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[YMM_TO_XMM_SUBWORD]) THEN
  SUBGOAL_THEN
   `read XMM7 s158 = pshufb_mask_val`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM7; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s158" THEN
  (* Step 159: sha256rnds2 xmm1, xmm2 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s159" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  FIRST_ASSUM(fun th ->
    let s = string_of_term (concl th) in
    if has_sub_string "XMM2 s158 =" s && has_sub_string "sha_ni_rnds2" s
    then RULE_ASSUM_TAC(REWRITE_RULE[th]) else FAIL_TAC "not found") THEN
  UNDISCH_THEN
   `read XMM1 s158 = ABEF_PACK
     (EL 0 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 56 W [a; b; c; d; e; ff; g; h]))`
   ...
   `read XMM1 s159 =
      sha_ni_rnds2
        ...
        (word_join4 (word_add (EL 58 sha256_K) (EL 58 W))
                    (word_add (EL 59 sha256_K) (EL 59 W))
                    (word_add (EL 56 sha256_K) (EL 56 W))
                    (word_add (EL 56 sha256_K) (EL 56 W))) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM1; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s159" THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WKDC_INNER_14; WKDC_OUTER_14]) THEN
  CUT_POINT_TAC_HW 14 `s159:x86state`;;

(* ========================================================================= *)
(* GROUP15_TAC: symbolic execution of group 15 (steps 160-167) + CUT_POINT 15.*)
(*                                                                           *)
(* G15 is the final round group.  Like G14 it has no MSG1/MSG2/PALIGNR/      *)
(* ext-PADDD (the schedule is fully extended after G14).  Novel to G15:      *)
(*   - `dec rdx` at step 165 (mid-group), mutating RDX and SOME_FLAGS.       *)
(*     MAYCHANGE already permits both.                                       *)
(*   - No ext-PADDD or MSG2 at the tail — the G13-style last-PADDD is        *)
(*     replaced by the epilogue add-back PADDDs (handled in POSTCOND).       *)
(*                                                                           *)
(* Register rotation: cur=XMM6 (post-G14), no MSG2/ext/MSG1 destinations.    *)
(*                                                                           *)
(* Instruction layout (pc+748..pc+778, steps 160..167):                      *)
(*   160: movdqa      xmm0, [rcx+240]   — K60..K63 load                      *)
(*   161: paddd       xmm0, xmm6        — K60..K63 + w60..w63                *)
(*   162: nop                                                                *)
(*   163: sha256rnds2 xmm2, xmm1        — 1st RNDS2 (BEFORE PSHUFD)          *)
(*   164: pshufd      xmm0, xmm0, 0x0e                                       *)
(*   165: dec         rdx                — mid-group RDX decrement           *)
(*   166: nop                                                                *)
(*   167: sha256rnds2 xmm1, xmm2        — 2nd RNDS2                          *)
(*                                                                           *)
(* Like G14, the 1st RNDS2 runs BEFORE the PSHUFD, so its wk has all 4 K+W   *)
(* lanes present; WKDC_INNER_15 absorbs the lanes-2/3 don't-care.  The CDGH  *)
(* shift for XMM2 (from ABEF_PACK (compress 58) to CDGH_PACK (compress 60))  *)
(* happens BEFORE step 163 since no MSG2 precedes it in G15.                 *)
(* ========================================================================= *)

let GROUP15_TAC : tactic =
  let WKDC_OUTER_15 = SPECL
   [`ABEF_PACK (EL 0 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 60 W [a;b;c;d;e;ff;g;h])) :int128`;
    `sha_ni_rnds2
       (CDGH_PACK (EL 2 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
                  (EL 3 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
                  (EL 6 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
                  (EL 7 (sha256_compress 60 W [a;b;c;d;e;ff;g;h])))
       (ABEF_PACK (EL 0 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
                  (EL 1 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
                  (EL 4 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
                  (EL 5 (sha256_compress 60 W [a;b;c;d;e;ff;g;h])))
       (word_join4 (word_add (EL 60 sha256_K) (EL 60 W))
                   (word_add (EL 61 sha256_K) (EL 61 W))
                   (word 0) (word 0)) :int128`;
    `word_add (EL 62 sha256_K) (EL 62 W) :int32`;
    `word_add (EL 63 sha256_K) (EL 63 W) :int32`;
    `word_add (EL 60 sha256_K) (EL 60 W) :int32`;
    `word_add (EL 60 sha256_K) (EL 60 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let WKDC_INNER_15 = SPECL
   [`CDGH_PACK (EL 2 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
               (EL 3 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
               (EL 6 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
               (EL 7 (sha256_compress 60 W [a;b;c;d;e;ff;g;h])) :int128`;
    `ABEF_PACK (EL 0 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
               (EL 1 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
               (EL 4 (sha256_compress 60 W [a;b;c;d;e;ff;g;h]))
               (EL 5 (sha256_compress 60 W [a;b;c;d;e;ff;g;h])) :int128`;
    `word_add (EL 60 sha256_K) (EL 60 W) :int32`;
    `word_add (EL 61 sha256_K) (EL 61 W) :int32`;
    `word_add (EL 62 sha256_K) (EL 62 W) :int32`;
    `word_add (EL 63 sha256_K) (EL 63 W) :int32`;
    `word 0:int32`; `word 0:int32`]
   SHA_NI_RNDS2_WK_DONTCARE in
  let len_h_thm = prove
   (`LENGTH [a:int32;b;c;d;e;ff;g;h] = 8`,
    REWRITE_TAC[LENGTH] THEN ARITH_TAC) in
  let compress_el_shift_14 =
    CONV_RULE(DEPTH_CONV NUM_ADD_CONV)
     (MATCH_MP
        (SPECL [`58`; `W:int32 list`; `[a:int32;b;c;d;e;ff;g;h]`]
               COMPRESS_EL_SHIFT_2)
        len_h_thm) in
  (* Step 160: movdqa xmm0, [rcx+240] (K60..K63) *)
  X86_STEPS_TAC HW_EXEC [160] THEN
  SUBGOAL_THEN
   `read XMM0 s160 = word_join4 (EL 60 sha256_K) (EL 61 sha256_K)
                              (EL 62 sha256_K) (EL 63 sha256_K) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 161: paddd xmm0, xmm6 — XMM6 s160 = word_join4 (EL 60..63 W) *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s161" THEN PADDD_REFOLD_TAC THEN
  SUBGOAL_THEN
   `read XMM0 s161 =
      word_join4 (word_add (EL 60 sha256_K) (EL 60 W))
                 (word_add (EL 61 sha256_K) (EL 61 W))
                 (word_add (EL 62 sha256_K) (EL 62 W))
                 (word_add (EL 63 sha256_K) (EL 63 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  DISCARD_OLDSTATE_TAC "s161" THEN
  (* Step 162: nop *)
  X86_STEPS_TAC HW_EXEC [162] THEN
  (* Shift XMM2 from ABEF_PACK (compress 58) to CDGH_PACK (compress 60) —
     done BEFORE step 163 RNDS2 since no MSG2 precedes it in G15. *)
  SUBGOAL_THEN
   `read XMM2 s162 = CDGH_PACK
     (EL 2 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))
     (EL 3 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))
     (EL 6 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))
     (EL 7 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))`
   ASSUME_TAC THENL
   [ASM_REWRITE_TAC[] THEN REWRITE_TAC[CDGH_EQ_ABEF] THEN
    REWRITE_TAC[compress_el_shift_14]; ALL_TAC] THEN
  UNDISCH_TAC `read XMM2 s162 = ABEF_PACK
     (EL 0 (sha256_compress 58 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 58 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 58 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 58 W [a; b; c; d; e; ff; g; h]))` THEN
  DISCH_THEN(K ALL_TAC) THEN
  (* Step 163: sha256rnds2 xmm2, xmm1 (1st RNDS2 BEFORE PSHUFD — all 4 wk
     lanes present, but RNDS2 only uses lanes 0,1; WKDC_INNER_15 absorbs
     the lanes-2,3 don't-care). *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s163" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  UNDISCH_THEN
   ...
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  UNDISCH_THEN
   `read XMM1 s162 = ABEF_PACK
     (EL 0 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))`
   (fun th -> RULE_ASSUM_TAC(REWRITE_RULE[th]) THEN ASSUME_TAC th) THEN
  ...
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
    String.length (string_of_term (concl th)) > 1500))) THEN
  DISCARD_OLDSTATE_TAC "s163" THEN
  (* Step 164: pshufd xmm0, xmm0, 0x0e *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s164" THEN
  RULE_ASSUM_TAC(CONV_RULE(DEPTH_CONV WORD_SIMPLE_SUBWORD_CONV)) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_JOIN4_SUBWORD]) THEN
  RULE_ASSUM_TAC(REWRITE_RULE[GSYM WORD_JOIN4_BALANCED]) THEN
  SUBGOAL_THEN
   `read XMM0 s164 =
      word_join4 (word_add (EL 62 sha256_K) (EL 62 W))
                 (word_add (EL 63 sha256_K) (EL 63 W))
                 (word_add (EL 60 sha256_K) (EL 60 W))
                 (word_add (EL 60 sha256_K) (EL 60 W))
      :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM0; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  (* Step 165: dec rdx — mutates RDX and SOME_FLAGS.  Plain X86_STEPS_TAC
     is fine since this is non-SIMD. *)
  X86_STEPS_TAC HW_EXEC [165] THEN
  (* Step 166: nop *)
  X86_STEPS_TAC HW_EXEC [166] THEN
  (* Step 167: sha256rnds2 xmm1, xmm2 *)
  X86_VERBOSE_STEP_TAC HW_EXEC "s167" THEN
  FOLD_SHA_NI_RNDS2_TAC THEN
  RULE_ASSUM_TAC(REWRITE_RULE[WORD_SUBWORD_JOIN_BOTTOM]) THEN
  REFOLD_INIT_GHOSTS_TAC THEN
  SUBSTITUTE_XMM_CLEANS_TAC THEN
  FIRST_ASSUM(fun th ->
    let s = string_of_term (concl th) in
    if has_sub_string "XMM2 s166 =" s && has_sub_string "sha_ni_rnds2" s
    then RULE_ASSUM_TAC(REWRITE_RULE[th]) else FAIL_TAC "not found") THEN
  UNDISCH_THEN
   `read XMM1 s166 = ABEF_PACK
     (EL 0 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))
     (EL 1 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))
     (EL 4 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))
     (EL 5 (sha256_compress 60 W [a; b; c; d; e; ff; g; h]))`
   ...
   `read XMM1 s167 =
      sha_ni_rnds2
        ...
        (word_join4 (word_add (EL 62 sha256_K) (EL 62 W))
                    (word_add (EL 63 sha256_K) (EL 63 W))
                    (word_add (EL 60 sha256_K) (EL 60 W))
                    (word_add (EL 60 sha256_K) (EL 60 W))) :int128`
   ASSUME_TAC THENL
   [REWRITE_TAC[XMM1; READ_ZEROTOP_128] THEN ASM_REWRITE_TAC[] THEN
    CONV_TAC WORD_BLAST; ALL_TAC] THEN
  TRY(FIRST_X_ASSUM(K ALL_TAC o check (fun th ->
  ...
  RULE_ASSUM_TAC(REWRITE_RULE[WKDC_INNER_15; WKDC_OUTER_15]) THEN
  CUT_POINT_TAC_HW 15 `s167:x86state`;;
