...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0xc5; 0xfd; 0xfb; 0xc1]; (* VPSUBQ ymm0, ymm0, ymm1 *)
 [0xc5; 0xf5; 0xfb; 0xca]; (* VPSUBQ ymm1, ymm1, ymm2 *)
 [0xc5; 0xed; 0xfb; 0xd3]; (* VPSUBQ ymm2, ymm2, ymm3 *)
 [0xc5; 0xe5; 0xfb; 0xdc]; (* VPSUBQ ymm3, ymm3, ymm4 *)
 [0xc5; 0xf9; 0xfb; 0xc1]; (* VPSUBQ xmm0, xmm0, xmm1 *)
 [0xc5; 0xf1; 0xfb; 0xca]; (* VPSUBQ xmm1, xmm1, xmm2 *)
 [0xc5; 0xe9; 0xfb; 0xd3]; (* VPSUBQ xmm2, xmm2, xmm3 *)
 [0xc5; 0xe1; 0xfb; 0xdc]; (* VPSUBQ xmm3, xmm3, xmm4 *)
 [0xc4; 0x41; 0x3d; 0xfb; 0xc1]; (* VPSUBQ ymm8, ymm8, ymm9 *)
 [0xc4; 0x41; 0x2d; 0xfb; 0xd3]; (* VPSUBQ ymm10, ymm10, ymm11 *)
 [0xc4; 0x41; 0x1d; 0xfb; 0xe5]; (* VPSUBQ ymm12, ymm12, ymm13 *)
 [0xc4; 0x41; 0x0d; 0xfb; 0xf7]; (* VPSUBQ ymm14, ymm14, ymm15 *)
 [0xc4; 0x41; 0x39; 0xfb; 0xc1]; (* VPSUBQ xmm8, xmm8, xmm9 *)
 [0xc4; 0x41; 0x29; 0xfb; 0xd3]; (* VPSUBQ xmm10, xmm10, xmm11 *)
 [0xc4; 0x41; 0x19; 0xfb; 0xe5]; (* VPSUBQ xmm12, xmm12, xmm13 *)
 [0xc4; 0x41; 0x09; 0xfb; 0xf7]; (* VPSUBQ xmm14, xmm14, xmm15 *)
 ...
 [0xc4; 0xe3; 0x69; 0x44; 0xcb; 0x00]; (* VPCLMULQDQ (%_% xmm1) (%_% xmm2) (%_% xmm3) (Imm8 (word 0)) *)
 [0xc4; 0xe3; 0x69; 0x44; 0xcb; 0x01]; (* VPCLMULQDQ (%_% xmm1) (%_% xmm2) (%_% xmm3) (Imm8 (word 1)) *)
 [0xc4; 0xe3; 0x69; 0x44; 0xcb; 0x10]; (* VPCLMULQDQ (%_% xmm1) (%_% xmm2) (%_% xmm3) (Imm8 (word 16)) *)
 [0xc4; 0xe3; 0x69; 0x44; 0xcb; 0x11]; (* VPCLMULQDQ (%_% xmm1) (%_% xmm2) (%_% xmm3) (Imm8 (word 17)) *)
 [0xc4; 0xe3; 0x6d; 0x44; 0xcb; 0x00]; (* VPCLMULQDQ (%_% ymm1) (%_% ymm2) (%_% ymm3) (Imm8 (word 0)) *)
 [0xc4; 0xe3; 0x6d; 0x44; 0xcb; 0x11]; (* VPCLMULQDQ (%_% ymm1) (%_% ymm2) (%_% ymm3) (Imm8 (word 17)) *)
 [0xc4; 0xe3; 0x79; 0x44; 0xc0; 0x00]; (* VPCLMULQDQ (%_% xmm0) (%_% xmm0) (%_% xmm0) (Imm8 (word 0)) *)
 [0xc4; 0xe3; 0x49; 0x44; 0xfd; 0x10]; (* VPCLMULQDQ (%_% xmm7) (%_% xmm6) (%_% xmm5) (Imm8 (word 16)) *)
 [0xc4; 0x43; 0x31; 0x44; 0xd0; 0x11]; (* VPCLMULQDQ (%_% xmm10) (%_% xmm9) (%_% xmm8) (Imm8 (word 17)) *)
 [0xc4; 0x43; 0x35; 0x44; 0xd0; 0x00]; (* VPCLMULQDQ (%_% ymm10) (%_% ymm9) (%_% ymm8) (Imm8 (word 0)) *)
 ...
 (* VAESENC (xmm only) *)
 [0xc4; 0xe2; 0x69; 0xdc; 0xcb]; (* VAESENC xmm1, xmm2, xmm3 *)
 [0xc4; 0xe2; 0x79; 0xdc; 0xff]; (* VAESENC xmm7, xmm0, xmm7 *)
 [0xc4; 0x42; 0x31; 0xdc; 0xc0]; (* VAESENC xmm8, xmm9, xmm8 *)
 [0xc4; 0x42; 0x11; 0xdc; 0xef]; (* VAESENC xmm13, xmm13, xmm15 *)
 [0xc4; 0x42; 0x01; 0xdc; 0xff]; (* VAESENC xmm15, xmm15, xmm15 *)
 [0xc4; 0xc2; 0x49; 0xdc; 0xf9]; (* VAESENC xmm7, xmm6, xmm9 *)
 [0xc4; 0x42; 0x01; 0xdc; 0xe1]; (* VAESENC xmm12, xmm15, xmm9 *)
 (* VAESENCLAST (xmm only) *)
 [0xc4; 0xe2; 0x69; 0xdd; 0xcb]; (* VAESENCLAST xmm1, xmm2, xmm3 *)
 [0xc4; 0xe2; 0x79; 0xdd; 0xff]; (* VAESENCLAST xmm7, xmm0, xmm7 *)
 [0xc4; 0x42; 0x31; 0xdd; 0xc0]; (* VAESENCLAST xmm8, xmm9, xmm8 *)
 [0xc4; 0x42; 0x11; 0xdd; 0xef]; (* VAESENCLAST xmm13, xmm13, xmm15 *)
 [0xc4; 0x42; 0x01; 0xdd; 0xff]; (* VAESENCLAST xmm15, xmm15, xmm15 *)
 [0xc4; 0xc2; 0x49; 0xdd; 0xf9]; (* VAESENCLAST xmm7, xmm6, xmm9 *)
 [0xc4; 0x42; 0x01; 0xdd; 0xe1]; (* VAESENCLAST xmm12, xmm15, xmm9 *)
 (* VPADDB: xmm and ymm, register variety *)
 [0xc5; 0xe9; 0xfc; 0xcb]; (* VPADDB xmm1, xmm2, xmm3 *)
 [0xc5; 0xf9; 0xfc; 0xff]; (* VPADDB xmm7, xmm0, xmm7 *)
 [0xc4; 0x41; 0x31; 0xfc; 0xd0]; (* VPADDB xmm10, xmm9, xmm8 *)
 [0xc4; 0x41; 0x09; 0xfc; 0xef]; (* VPADDB xmm13, xmm14, xmm15 *)
 [0xc5; 0xed; 0xfc; 0xcb]; (* VPADDB ymm1, ymm2, ymm3 *)
 [0xc5; 0xfd; 0xfc; 0xff]; (* VPADDB ymm7, ymm0, ymm7 *)
 [0xc4; 0x41; 0x35; 0xfc; 0xd0]; (* VPADDB ymm10, ymm9, ymm8 *)
 [0xc4; 0x41; 0x0d; 0xfc; 0xef]; (* VPADDB ymm13, ymm14, ymm15 *)
 (* VPALIGNR: xmm and ymm, mix of immediates incl. 0, small, 15, 16, 31, 0xff *)
 [0xc4; 0xe3; 0x69; 0x0f; 0xcb; 0x00]; (* VPALIGNR xmm1, xmm2, xmm3, 0 *)
 [0xc4; 0xe3; 0x69; 0x0f; 0xcb; 0x01]; (* VPALIGNR xmm1, xmm2, xmm3, 1 *)
 [0xc4; 0xe3; 0x69; 0x0f; 0xcb; 0x08]; (* VPALIGNR xmm1, xmm2, xmm3, 8 *)
 [0xc4; 0xe3; 0x69; 0x0f; 0xcb; 0x0f]; (* VPALIGNR xmm1, xmm2, xmm3, 15 *)
 [0xc4; 0xe3; 0x69; 0x0f; 0xcb; 0x10]; (* VPALIGNR xmm1, xmm2, xmm3, 16 *)
 [0xc4; 0xe3; 0x69; 0x0f; 0xcb; 0x1f]; (* VPALIGNR xmm1, xmm2, xmm3, 31 *)
 [0xc4; 0xe3; 0x69; 0x0f; 0xcb; 0xff]; (* VPALIGNR xmm1, xmm2, xmm3, 255 *)
 [0xc4; 0x43; 0x01; 0x0f; 0xf7; 0x05]; (* VPALIGNR xmm14, xmm15, xmm15, 5 *)
 [0xc4; 0x43; 0x29; 0x0f; 0xe1; 0x0a]; (* VPALIGNR xmm12, xmm10, xmm9, 10 *)
 [0xc4; 0xe3; 0x6d; 0x0f; 0xcb; 0x00]; (* VPALIGNR ymm1, ymm2, ymm3, 0 *)
 [0xc4; 0xe3; 0x6d; 0x0f; 0xcb; 0x04]; (* VPALIGNR ymm1, ymm2, ymm3, 4 *)
 [0xc4; 0xe3; 0x6d; 0x0f; 0xcb; 0x0f]; (* VPALIGNR ymm1, ymm2, ymm3, 15 *)
 [0xc4; 0xe3; 0x6d; 0x0f; 0xcb; 0x10]; (* VPALIGNR ymm1, ymm2, ymm3, 16 *)
 [0xc4; 0xe3; 0x6d; 0x0f; 0xcb; 0x1f]; (* VPALIGNR ymm1, ymm2, ymm3, 31 *)
 [0xc4; 0xe3; 0x6d; 0x0f; 0xcb; 0xff]; (* VPALIGNR ymm1, ymm2, ymm3, 255 *)
 [0xc4; 0x43; 0x05; 0x0f; 0xf7; 0x0c]; (* VPALIGNR ymm14, ymm15, ymm15, 12 *)
 [0xc4; 0x43; 0x2d; 0x0f; 0xe1; 0x06]; (* VPALIGNR ymm12, ymm10, ymm9, 6 *)
 (* VPSLLDQ: xmm and ymm, range of immediates. dest in VEX.vvvv, src in r/m *)
 [0xc5; 0xf1; 0x73; 0xfa; 0x00]; (* VPSLLDQ xmm1, xmm2, 0 *)
 [0xc5; 0xf1; 0x73; 0xfa; 0x01]; (* VPSLLDQ xmm1, xmm2, 1 *)
 [0xc5; 0xf1; 0x73; 0xfa; 0x08]; (* VPSLLDQ xmm1, xmm2, 8 *)
 [0xc5; 0xf1; 0x73; 0xfa; 0x0f]; (* VPSLLDQ xmm1, xmm2, 15 *)
 [0xc5; 0xf1; 0x73; 0xfa; 0x10]; (* VPSLLDQ xmm1, xmm2, 16 *)
 [0xc5; 0xf1; 0x73; 0xfa; 0xff]; (* VPSLLDQ xmm1, xmm2, 255 *)
 [0xc4; 0xc1; 0x11; 0x73; 0xf9; 0x07]; (* VPSLLDQ xmm13, xmm9, 7 *)
 [0xc4; 0xc1; 0x01; 0x73; 0xff; 0x0a]; (* VPSLLDQ xmm15, xmm15, 10 *)
 [0xc5; 0xf5; 0x73; 0xfa; 0x00]; (* VPSLLDQ ymm1, ymm2, 0 *)
 [0xc5; 0xf5; 0x73; 0xfa; 0x03]; (* VPSLLDQ ymm1, ymm2, 3 *)
 [0xc5; 0xf5; 0x73; 0xfa; 0x0f]; (* VPSLLDQ ymm1, ymm2, 15 *)
 [0xc5; 0xf5; 0x73; 0xfa; 0x10]; (* VPSLLDQ ymm1, ymm2, 16 *)
 [0xc5; 0xf5; 0x73; 0xfa; 0xff]; (* VPSLLDQ ymm1, ymm2, 255 *)
 [0xc4; 0xc1; 0x15; 0x73; 0xf9; 0x07]; (* VPSLLDQ ymm13, ymm9, 7 *)
 [0xc4; 0xc1; 0x05; 0x73; 0xff; 0x0c]; (* VPSLLDQ ymm15, ymm15, 12 *)
];;
...
[
  ...
  (* VAESENC/VAESENCLAST: [rsp+offset] forms (128-bit memory) *)
  [0xc4; 0xe2; 0x69; 0xdc; 0x4c; 0x24; 0x20]; (* VAESENC xmm1, xmm2, [rsp + 0x20] *)
  [0xc4; 0x62; 0x31; 0xdc; 0x7c; 0x24; 0x40]; (* VAESENC xmm15, xmm9, [rsp + 0x40] *)
  [0xc4; 0xe2; 0x69; 0xdd; 0x4c; 0x24; 0x20]; (* VAESENCLAST xmm1, xmm2, [rsp + 0x20] *)
  [0xc4; 0x62; 0x31; 0xdd; 0x7c; 0x24; 0x40]; (* VAESENCLAST xmm15, xmm9, [rsp + 0x40] *)
  (* VPADDB memory *)
  [0xc5; 0xe9; 0xfc; 0x4c; 0x24; 0x20]; (* VPADDB xmm1, xmm2, [rsp + 0x20] *)
  [0xc5; 0xed; 0xfc; 0x4c; 0x24; 0x40]; (* VPADDB ymm1, ymm2, [rsp + 0x40] *)
  [0xc5; 0x31; 0xfc; 0x7c; 0x24; 0x60]; (* VPADDB xmm15, xmm9, [rsp + 0x60] *)
  [0xc5; 0x35; 0xfc; 0x3c; 0x24]; (* VPADDB ymm15, ymm9, [rsp] *)
  (* VPALIGNR memory *)
  [0xc4; 0xe3; 0x69; 0x0f; 0x4c; 0x24; 0x20; 0x05]; (* VPALIGNR xmm1, xmm2, [rsp + 0x20], 5 *)
  [0xc4; 0xe3; 0x6d; 0x0f; 0x4c; 0x24; 0x40; 0x10]; (* VPALIGNR ymm1, ymm2, [rsp + 0x40], 16 *)
  [0xc4; 0x63; 0x29; 0x0f; 0x7c; 0x24; 0x60; 0x0c]; (* VPALIGNR xmm15, xmm10, [rsp + 0x60], 12 *)
  [0xc4; 0x63; 0x2d; 0x0f; 0x7c; 0x24; 0x20; 0x18]; (* VPALIGNR ymm15, ymm10, [rsp + 0x20], 24 *)
];;
