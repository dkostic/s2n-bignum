...
[[0x48; 0x0f; 0xb7; 0xc2];  (* MOVZX (% rax) (% dx) *)
 ...
 [0x66; 0x0f; 0x6d; 0xc7]; (* PUNPCKHQDQ xmm0, xmm7 *)
 [0x66; 0x45; 0x0f; 0x6d; 0xdc]; (* PUNPCKHQDQ xmm11, xmm12 *)
 (* SSE2: PSLLD *)
 [0x66; 0x0f; 0x72; 0xf1; 0x07]; (* PSLLD xmm1, 7 *)
 [0x66; 0x41; 0x0f; 0x72; 0xf1; 0x1f]; (* PSLLD xmm9, 31 *)
 [0x66; 0x0f; 0x72; 0xf0; 0x00]; (* PSLLD xmm0, 0 *)
 (* SSE2: PSRLD *)
 [0x66; 0x0f; 0x72; 0xd2; 0x10]; (* PSRLD xmm2, 16 *)
 [0x66; 0x41; 0x0f; 0x72; 0xd2; 0x01]; (* PSRLD xmm10, 1 *)
 [0x66; 0x0f; 0x72; 0xd7; 0x1f]; (* PSRLD xmm7, 31 *)
 (* SSE2: PSLLDQ *)
 [0x66; 0x0f; 0x73; 0xf8; 0x04]; (* PSLLDQ xmm0, 4 *)
 [0x66; 0x41; 0x0f; 0x73; 0xf8; 0x0c]; (* PSLLDQ xmm8, 12 *)
 [0x66; 0x0f; 0x73; 0xf9; 0x00]; (* PSLLDQ xmm1, 0 *)
 (* SSE2: PSRLDQ *)
 [0x66; 0x0f; 0x73; 0xd9; 0x08]; (* PSRLDQ xmm1, 8 *)
 [0x66; 0x41; 0x0f; 0x73; 0xdf; 0x01]; (* PSRLDQ xmm15, 1 *)
 [0x66; 0x0f; 0x73; 0xda; 0x0f]; (* PSRLDQ xmm2, 15 *)
 (* SSE2: PSRLQ *)
 [0x66; 0x0f; 0x73; 0xd0; 0x20]; (* PSRLQ xmm0, 32 *)
 [0x66; 0x0f; 0x73; 0xd7; 0x01]; (* PSRLQ xmm7, 1 *)
 [0x66; 0x41; 0x0f; 0x73; 0xd4; 0x3f]; (* PSRLQ xmm12, 63 *)
 (* SSSE3: PALIGNR *)
 [0x66; 0x0f; 0x3a; 0x0f; 0xca; 0x04]; (* PALIGNR xmm1, xmm2, 4 *)
 [0x66; 0x0f; 0x3a; 0x0f; 0xf8; 0x08]; (* PALIGNR xmm7, xmm0, 8 *)
 [0x66; 0x45; 0x0f; 0x3a; 0x0f; 0xca; 0x0c]; (* PALIGNR xmm9, xmm10, 12 *)
 [0x66; 0x44; 0x0f; 0x3a; 0x0f; 0xfb; 0x00]; (* PALIGNR xmm15, xmm3, 0 *)
 [0x66; 0x0f; 0x3a; 0x0f; 0xc9; 0x10]; (* PALIGNR xmm1, xmm1, 16 *)
 (* SHA-NI: SHA256RNDS2 (implicit xmm0) *)
 [0x0f; 0x38; 0xcb; 0xca]; (* SHA256RNDS2 xmm1, xmm2 *)
 [0x0f; 0x38; 0xcb; 0xf8]; (* SHA256RNDS2 xmm7, xmm0 *)
 [0x45; 0x0f; 0x38; 0xcb; 0xca]; (* SHA256RNDS2 xmm9, xmm10 *)
 [0x0f; 0x38; 0xcb; 0xdb]; (* SHA256RNDS2 xmm3, xmm3 *)
 (* SHA-NI: SHA256MSG1 *)
 [0x0f; 0x38; 0xcc; 0xca]; (* SHA256MSG1 xmm1, xmm2 *)
 [0x0f; 0x38; 0xcc; 0xf8]; (* SHA256MSG1 xmm7, xmm0 *)
 [0x45; 0x0f; 0x38; 0xcc; 0xca]; (* SHA256MSG1 xmm9, xmm10 *)
 (* SHA-NI: SHA256MSG2 *)
 [0x0f; 0x38; 0xcd; 0xca]; (* SHA256MSG2 xmm1, xmm2 *)
 [0x0f; 0x38; 0xcd; 0xf8]; (* SHA256MSG2 xmm7, xmm0 *)
 [0x45; 0x0f; 0x38; 0xcd; 0xca]; (* SHA256MSG2 xmm9, xmm10 *)
 (* AVX: VPALIGNR xmm *)
 [0xc4; 0xe3; 0x69; 0x0f; 0xcb; 0x04]; (* VPALIGNR xmm1, xmm2, xmm3, 4 *)
 [0xc4; 0xe3; 0x79; 0x0f; 0xfd; 0x08]; (* VPALIGNR xmm7, xmm0, xmm5, 8 *)
 [0xc4; 0x43; 0x29; 0x0f; 0xcb; 0x0c]; (* VPALIGNR xmm9, xmm10, xmm11, 12 *)
 [0xc4; 0xe3; 0x01; 0x0f; 0xc1; 0x00]; (* VPALIGNR xmm0, xmm15, xmm1, 0 *)
 (* AVX: VPALIGNR ymm *)
 [0xc4; 0xe3; 0x6d; 0x0f; 0xcb; 0x04]; (* VPALIGNR ymm1, ymm2, ymm3, 4 *)
 [0xc4; 0xe3; 0x7d; 0x0f; 0xfd; 0x08]; (* VPALIGNR ymm7, ymm0, ymm5, 8 *)
 (* AVX: VPSHUFD xmm *)
 [0xc5; 0xf9; 0x70; 0xca; 0x1b]; (* VPSHUFD xmm1, xmm2, 0x1b *)
 [0xc5; 0xf9; 0x70; 0xf8; 0x4e]; (* VPSHUFD xmm7, xmm0, 0x4e *)
 [0xc4; 0x41; 0x79; 0x70; 0xca; 0x93]; (* VPSHUFD xmm9, xmm10, 0x93 *)
 [0xc5; 0xf9; 0x70; 0xc0; 0x00]; (* VPSHUFD xmm0, xmm0, 0x00 *)
 [0xc5; 0xf9; 0x70; 0xc0; 0xff]; (* VPSHUFD xmm0, xmm0, 0xff *)
 (* AVX: VPSHUFD ymm *)
 [0xc5; 0xfd; 0x70; 0xca; 0x1b]; (* VPSHUFD ymm1, ymm2, 0x1b *)
 [0xc5; 0xfd; 0x70; 0xf8; 0x4e]; (* VPSHUFD ymm7, ymm0, 0x4e *)
 [0xc4; 0x41; 0x7d; 0x70; 0xca; 0x93]; (* VPSHUFD ymm9, ymm10, 0x93 *)
 (* AVX: VZEROUPPER - not cosimulated because it is modeled as a no-op
    (it only zeros upper ZMM bits 256-511 which the proof framework
    does not track), so the formal model output won't match hardware *)
...
[
  ...
  (* Memory operand tests for new instructions *)
  [0x66; 0x0f; 0x6c; 0x4c; 0x24; 0x20]; (* PUNPCKLQDQ xmm1, [rsp+0x20] *)
  [0x66; 0x0f; 0x6d; 0x5c; 0x24; 0x20]; (* PUNPCKHQDQ xmm3, [rsp+0x20] *)
  [0x66; 0x0f; 0x3a; 0x0f; 0x4c; 0x24; 0x20; 0x04]; (* PALIGNR xmm1, [rsp+0x20], 4 *)
  [0x66; 0x44; 0x0f; 0x3a; 0x0f; 0x4c; 0x24; 0x20; 0x08]; (* PALIGNR xmm9, [rsp+0x20], 8 *)
  [0x0f; 0x38; 0xcb; 0x4c; 0x24; 0x20]; (* SHA256RNDS2 xmm1, [rsp+0x20] *)
  [0x0f; 0x38; 0xcb; 0x7c; 0x24; 0x20]; (* SHA256RNDS2 xmm7, [rsp+0x20] *)
  [0x0f; 0x38; 0xcc; 0x4c; 0x24; 0x20]; (* SHA256MSG1 xmm1, [rsp+0x20] *)
  [0x0f; 0x38; 0xcd; 0x4c; 0x24; 0x20]; (* SHA256MSG2 xmm1, [rsp+0x20] *)
  [0xc4; 0xe3; 0x69; 0x0f; 0x4c; 0x24; 0x20; 0x04]; (* VPALIGNR xmm1, xmm2, [rsp+0x20], 4 *)
  [0xc4; 0xe3; 0x6d; 0x0f; 0x4c; 0x24; 0x20; 0x04]; (* VPALIGNR ymm1, ymm2, [rsp+0x20], 4 *)
  [0xc5; 0xf9; 0x70; 0x4c; 0x24; 0x20; 0x1b]; (* VPSHUFD xmm1, [rsp+0x20], 0x1b *)
  [0xc5; 0xfd; 0x70; 0x4c; 0x24; 0x20; 0x1b]; (* VPSHUFD ymm1, [rsp+0x20], 0x1b *)
  [0x66; 0x0f; 0x70; 0x4c; 0x24; 0x20; 0x1b]; (* PSHUFD xmm1, [rsp+0x20], 0x1b *)
];;
