...
*)
let mlkem_reduce_mc = define_assert_from_elf "mlkem_reduce_mc" "x86/tutorial/mlkem_reduce.o"
[
...
let MLKEM_POLY_REDUCE_EXEC = X86_MK_CORE_EXEC_RULE mlkem_reduce_tmc;;
...
let MLKEM_REDUCE_CORRECT = prove(
  ...
  ASM_REWRITE_TAC[WORD_ADD_0] THEN DISCARD_STATE_TAC "s168" THEN
