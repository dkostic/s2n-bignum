...
let MLKEM_AVX2_NTT_ORDER_CLAUSES = end_itlist CONJ (map
 (GEN_REWRITE_CONV I [mlkem_avx2_ntt_order] THENC DEPTH_CONV WORD_NUM_RED_CONV THENC
  GEN_REWRITE_CONV I [BITREVERSE7_CLAUSES])
 (map (curry mk_comb `mlkem_avx2_ntt_order` o mk_small_numeral) (0--127)));;
